...
var tns = function() {
    var e = window
      , Kt = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.msRequestAnimationFrame || function(e) {
        return setTimeout(e, 16)
    }
      , t = window
      , Qt = t.cancelAnimationFrame || t.mozCancelAnimationFrame || function(e) {
        clearTimeout(e)
    }
    ;
    function extend() {
    ...
    function setFakeBody(e) {
        var t = "";
        return e.fake && (t = n.style.overflow,
        e.style.background = "",
    ...
    function calc() {
        ...
        return t.fake ? resetFakeBody(t, n) : i.remove(),
        o
    }
    function percentageLayout() {
        ...
        i.appendChild(o),
        t.appendChild(i),
        l = Math.abs(i.getBoundingClientRect().left - o.children[r - s].getBoundingClientRect().left) < 2,
        t.fake ? resetFakeBody(t, n) : i.remove(),
        l
    }
    function mediaquerySupport() {
        if (window.matchMedia || window.msMatchMedia)
            return !0;
        var e, t = document, n = getBody(), i = setFakeBody(n), o = t.createElement("div"), a = t.createElement("style"), r = "@media all and (min-width:1px){.tns-mq-test{position:absolute}}";
        return a.type = "text/css",
        o.className = "tns-mq-test",
        n.appendChild(a),
        n.appendChild(o),
        a.styleSheet ? a.styleSheet.cssText = r : a.appendChild(t.createTextNode(r)),
        e = window.getComputedStyle ? window.getComputedStyle(o).position : o.currentStyle.position,
        n.fake ? resetFakeBody(n, i) : o.remove(),
        "absolute" === e
    }
    function createStyleSheet(e, t) {
        var n = document.createElement("style");
        return e && n.setAttribute("media", e),
    ...
    function getTouchDirection(e, t) {
        ...
        return 90 - t <= i ? n = "horizontal" : i <= t && (n = "vertical"),
        n
    }
    ...
    : function(e, t) {
      ...
      , Yt = i ? function(e, t) {
        Xt(e, t) || e.classList.add(t)
    }
    : function(e, t) {
        Xt(e, t) || (e.className += " " + t)
    }
      , Zt = i ? function(e, t) {
        Xt(e, t) && e.classList.remove(t)
    }
    : function(e, t) {
        Xt(e, t) && (e.className = e.className.replace(t, ""))
    }
    ;
    ...
    function setAttrs(e, t) {
        if (e = isNodeList(e) || e instanceof Array ? e : [e],
    ...
    function whichProperty(t) {
        ...
        for (var o = document.createElement("fakeelement"), a = (t.length,
        0); a < t.length; a++) {
            var r = t[a];
            if (void 0 !== o.style[r])
                return r
    ...
    function has3DTransforms(e) {
        ...
        if (!window.getComputedStyle)
            return !1;
        var t, n = document, i = getBody(), o = setFakeBody(i), a = n.createElement("p"), r = 9 < e.length ? "-" + e.slice(0, -9).toLowerCase() + "-" : "";
        return r += "transform",
        i.insertBefore(a, null),
        a.style[e] = "translate3d(1px,1px,1px)",
        t = window.getComputedStyle(a).getPropertyValue(r),
        i.fake ? resetFakeBody(i, o) : a.remove(),
    ...
    function jsTransform(e, t, n, i, o, a, r) {
        var s = Math.min(a, 10)
          , l = 0 <= o.indexOf("%") ? "%" : "px"
          , u = (o = o.replace(l, ""),
        Number(e.style[t].replace(n, "").replace(i, "").replace(l, "")))
          , d = (o - u) / a * s;
    ...
    var s = function tns(M) {
        ...
        var u = t.tC ? checkStorageValue(t.tC) : setLocalStorage(t, "tC", calc(), n)
          , m = t.tPL ? checkStorageValue(t.tPL) : setLocalStorage(t, "tPL", percentageLayout(), n)
          , R = t.tMQ ? checkStorageValue(t.tMQ) : setLocalStorage(t, "tMQ", mediaquerySupport(), n)
          , a = t.tTf ? checkStorageValue(t.tTf) : setLocalStorage(t, "tTf", whichProperty("transform"), n)
          , r = t.t3D ? checkStorageValue(t.t3D) : setLocalStorage(t, "t3D", has3DTransforms(a), n)
          , y = t.tTDu ? checkStorageValue(t.tTDu) : setLocalStorage(t, "tTDu", whichProperty("transitionDuration"), n)
          , s = t.tTDe ? checkStorageValue(t.tTDe) : setLocalStorage(t, "tTDe", whichProperty("transitionDelay"), n)
          , S = t.tADu ? checkStorageValue(t.tADu) : setLocalStorage(t, "tADu", whichProperty("animationDuration"), n)
          , l = t.tADe ? checkStorageValue(t.tADe) : setLocalStorage(t, "tADe", whichProperty("animationDelay"), n)
          , d = t.tTE ? checkStorageValue(t.tTE) : setLocalStorage(t, "tTE", getEndProperty(y, "Transition"), n)
          , c = t.tAE ? checkStorageValue(t.tAE) : setLocalStorage(t, "tAE", getEndProperty(S, "Animation"), n)
          , f = h.console && "function" == typeof h.console.warn
        ...
        if (p.forEach(function(e) {
            if ("string" == typeof M[e]) {
                ...
                if (g[e] = t,
                !n || !n.nodeName)
                    return void (f && console.warn("Can't find", M[e]));
                M[e] = n
            }
        }),
        !(M.container.children.length < 1)) {
            ...
            var w, N, P = "horizontal" === M.axis, L = k.createElement("div"), W = k.createElement("div"), H = M.container, O = H.parentNode, V = H.outerHTML, z = H.children, F = z.length, G = getWindowWidth(), q = !1;
            B && setBreakpointZone(),
            I && (H.className += " tns-vpfix");
            var j, U, _, K = M.autoWidth, Q = getOption("fixedWidth"), X = getOption("edgePadding"), Y = getOption("gutter"), Z = getViewportWidth(), J = getOption("center"), $ = K ? 1 : Math.floor(getOption("items")), ee = getOption("slideBy"), te = M.viewportMax || M.fixedWidthViewportWidth, ne = getOption("arrowKeys"), ie = getOption("speed"), oe = M.rewind, ae = !oe && M.loop, re = getOption("autoHeight"), se = getOption("controls"), le = getOption("controlsText"), ue = getOption("nav"), de = getOption("touch"), ce = getOption("mouseDrag"), fe = getOption("autoplay"), pe = getOption("autoplayTimeout"), ge = getOption("autoplayText"), ve = getOption("autoplayHoverPause"), he = getOption("autoplayResetOnVisibility"), me = createStyleSheet(null, getOption("nonce")), ye = M.lazyload, Se = M.lazyloadSelector, Ce = [], Ee = ae ? getCloneCountForLoop() : 0, be = I ? F + 2 * Ee : F + Ee, Te = !(!Q && !K || ae), xe = Q ? getRightBoundary() : null, Ae = !I || !ae, we = P ? "left" : "top", Le = "", Oe = "", Me = Q ? function() {
                return J && !ae ? F - 1 : Math.ceil(-xe / (Q + Y))
            }
            : K ? function() {
                for (var e = 0; e < be; e++)
                    if (j[e] >= -xe)
            ...
            : function() {
                return J && I && !ae ? F - 1 : ae || I ? Math.max(0, be - Math.ceil($)) : be - 1
            }
            , ke = getStartIndex(getOption("startIndex")), Re = ke, Be = (getCurrentSlide(),
            0), De = K ? null : Me(), Ie = M.preventActionWhenRunning, Ne = M.swipeAngle, Pe = !Ne || "?", We = !1, He = M.onInit, Ve = new Events, ze = " tns-slider tns-" + M.mode, Fe = H.id || getSlideId(), Ge = getOption("disable"), qe = !1, je = M.freezable, Ue = !(!je || K) && getFreeze(), _e = !1, Ke = {
                ...
                mouseup: onPanEnd,
                mouseleave: onPanEnd
            }, et = hasOption("controls"), tt = hasOption("nav"), nt = !!K || M.navAsThumbnails, it = hasOption("autoplay"), ot = hasOption("touch"), at = hasOption("mouseDrag"), rt = "tns-slide-active", st = "tns-slide-cloned", lt = "tns-complete", ut = {
                load: onImgLoaded,
                error: onImgFailed
            }, dt = "force" === M.preventScrollOnTouch;
            if (et)
                var ct, ft, pt = M.controlsContainer, gt = M.controlsContainer ? M.controlsContainer.outerHTML : "", vt = M.prevButton, ht = M.nextButton, mt = M.prevButton ? M.prevButton.outerHTML : "", yt = M.nextButton ? M.nextButton.outerHTML : "";
            if (tt)
                var St, Ct = M.navContainer, Et = M.navContainer ? M.navContainer.outerHTML : "", bt = K ? F : getPages(), Tt = 0, xt = -1, At = getCurrentNavIndex(), wt = At, Lt = "tns-nav-active", Ot = "Carousel Page ", Mt = " (Current Slide)";
            if (it)
                var kt, Rt, Bt, Dt, It, Nt = "forward" === M.autoplayDirection ? 1 : -1, Pt = M.autoplayButton, Wt = M.autoplayButton ? M.autoplayButton.outerHTML : "", Ht = ["<span class='tns-visually-hidden'>", " animation</span>"];
            if (ot || at)
                var Vt, zt, Ft = {}, Gt = {}, qt = !1, jt = P ? function(e, t) {
                    return e.x - t.x
                }
                : function(e, t) {
                    return e.y - t.y
                ...
                ;
            K || resetVariblesWhenDisable(Ge || Ue),
            a && (we = a,
            Le = "translate",
            Oe = r ? (Le += P ? "3d(" : "3d(0px, ",
            P ? ", 0px, 0px)" : ", 0px)") : (Le += P ? "X(" : "Y(",
            ")")),
            I && (H.className = H.className.replace("tns-vpfix", "")),
            initStructure(),
            initSheet(),
            initSliderTransform();
            var Ut = ae ? I ? function() {
                var e = Be
                  , t = De;
                e += ee,
                t -= ee,
            ...
            : function() {
                ke = Math.max(Be, Math.min(De, ke))
            }
              , _t = I ? function() {
                resetDuration(H, ""),
                y || !ie ? (doContainerTransform(),
                ie && isVisible(H) || onTransitionEnd()) : jsTransform(H, we, Le, Oe, getContainerTransformValue(), ie, onTransitionEnd),
                P || updateContentWrapperHeight()
            }
            : function() {
                Ce = [];
                var e = {};
                e[d] = e[c] = onTransitionEnd,
                removeEvents(z[Re], e),
                addEvents(z[ke], e),
                animateSlide(Re, b, T, !0),
                animateSlide(ke, A, b),
                d && c && ie && isVisible(H) || onTransitionEnd()
            }
            ;
            return {
                version: "2.9.3",
                ...
                rebuild: function rebuild() {
                    return tns(extend(M, g))
                }
            }
        }
        function updateOptions(e) {
            for (var t in e)
                I || ("slideBy" === t && (e[t] = "page"),
                "edgePadding" === t && (e[t] = !1),
                "autoHeight" === t && (e[t] = !1)),
                "responsive" === t && updateOptions(e[t])
        }
        function resetVariblesWhenDisable(e) {
            e && (se = ue = de = ce = ne = fe = ve = he = !1)
        }
        function getCurrentSlide() {
            for (var e = I ? ke - Ee : ke; e < 0; )
                e += F;
            return e % F + 1
        }
        function getStartIndex(e) {
            return e = e ? Math.max(0, Math.min(ae ? F - 1 : F - $, e)) : 0,
            I ? e + Ee : e
        }
        ...
        function getCurrentNavIndex() {
            var e, t = getAbsIndex();
            return e = nt ? t : Q || K ? Math.ceil((t + 1) * bt / F - 1) : Math.floor(t / $),
            !ae && I && ke === De && (e = bt - 1),
            e
        }
        function getItemsMax() {
            if (K || Q && !te)
                return F - 1;
            var e = Q ? "fixedWidth" : "items"
              , t = [];
            if ((Q || M[e] < F) && t.push(M[e]),
            B)
                for (var n in B) {
                    var i = B[n][e];
                    i && (Q || i < F) && t.push(i)
            ...
            Math.ceil(Q ? te / Math.min.apply(null, t) : Math.max.apply(null, t))
        }
        function getCloneCountForLoop() {
            var e = getItemsMax()
              , t = I ? Math.ceil((5 * e - F) / 2) : 4 * e - F;
            return t = Math.max(e, t),
            hasOption("edgePadding") ? t + 1 : t
        }
        function getWindowWidth() {
            return h.innerWidth || k.documentElement.clientWidth || k.body.clientWidth
        }
        ...
        function getOption(e, t) {
            if (null == t && (t = G),
            "items" === e && Q)
                return Math.floor((Z + Y) / (Q + Y)) || 1;
            var n = M[e];
            if (B)
                for (var i in B)
                    t >= parseInt(i) && e in B[i] && (n = B[i][e]);
            return "slideBy" === e && "page" === n && (n = getOption("items")),
            I || "slideBy" !== e && "items" !== e || (n = Math.floor(n)),
            n
        }
        function getSlideMarginLeft(e) {
            return u ? u + "(" + 100 * e + "% / " + be + ")" : 100 * e / be + "%"
        }
        function getInnerWrapperStyles(e, t, n, i, o) {
            var a = "";
            if (void 0 !== e) {
                var r = e;
                t && (r -= t),
                a = P ? "margin: 0 " + r + "px 0 " + e + "px;" : "margin: " + e + "px 0 " + r + "px 0;"
            } else if (t && !n) {
                var s = "-" + t + "px"
                  , l = P ? s + " 0 0" : "0 " + s + " 0";
                a = "margin: 0 " + l + ";"
            }
            return !I && o && y && i && (a += getTransitionDurationStyle(i)),
            a
        }
        function getContainerWidth(e, t, n) {
            return e ? (e + t) * be + "px" : u ? u + "(" + 100 * be + "% / " + n + ")" : 100 * be / n + "%"
        }
        ...
        function getTransitionDurationStyle(e) {
            return getCSSPrefix(y, 18) + "transition-duration:" + e / 1e3 + "s;"
        }
        function getAnimationDurationStyle(e) {
            return getCSSPrefix(S, 17) + "animation-duration:" + e / 1e3 + "s;"
        }
        function initStructure() {
            ...
            W.id = Fe + "-iw",
            "" === H.id && (H.id = Fe),
            ze += m || K ? " tns-subpixel" : " tns-no-subpixel",
            ze += u ? " tns-calc" : " tns-no-calc",
            K && (ze += " tns-autowidth"),
            ze += " tns-" + M.axis,
            H.className += ze,
            I ? (w = k.createElement("div"),
            w.id = Fe + "-mw",
            w.className = "tns-ovh",
            L.appendChild(w),
            w.appendChild(W)) : L.appendChild(W),
            re) {
                var n = w || W;
                n.className += " tns-ah"
            }
            if (O.insertBefore(L, H),
            W.appendChild(H),
            forEach(z, function(e, t) {
                Yt(e, "tns-item"),
                e.id || (e.id = Fe + "-item" + t),
                !I && A && Yt(e, A),
                setAttrs(e, {
            ...
            Ee) {
                for (var i = k.createDocumentFragment(), o = k.createDocumentFragment(), a = Ee; a--; ) {
                    var r = a % F
                      , s = z[r].cloneNode(!0);
                    if (Yt(s, st),
                    removeAttrs(s, "id"),
        ...
        function initSliderTransform() {
            if (hasOption("autoHeight") || K || !P) {
                var e = H.querySelectorAll("img");
                forEach(e, function(e) {
                    var t = e.src;
                    ye || (t && t.indexOf("data:image") < 0 ? (e.src = "",
                    addEvents(e, ut),
                    Yt(e, "loading"),
                    e.src = t) : imgLoaded(e))
                }),
                ...
                hasOption("autoHeight") && (e = getImageArray(ke, Math.min(ke + $ - 1, be - 1))),
                ye ? initSliderTransformStyleCheck() : Kt(function() {
                    imgsLoadedCheck(arrayFromNodeList(e), initSliderTransformStyleCheck)
                })
            } else
        ...
        function initSliderTransformStyleCheck() {
            if (K && 1 < F) {
                ...
                !function stylesApplicationCheck() {
                    var e = z[n].getBoundingClientRect().left
                      , t = z[n - 1].getBoundingClientRect().right;
                    Math.abs(e - t) <= 1 ? initSliderTransformCore() : setTimeout(function() {
        ...
        function initSliderTransformCore() {
            P && !K || (setSlidePositions(),
            K ? (xe = getRightBoundary(),
            je && (Ue = getFreeze()),
            De = Me(),
            resetVariblesWhenDisable(Ge || Ue)) : updateContentWrapperHeight()),
            I && doContainerTransformSilent(),
            initTools(),
            initEvents()
        }
        function initSheet() {
            if (!I)
                for (var e = ke, t = ke + Math.min(F, $); e < t; e++) {
                    var n = z[e];
                    n.style.left = 100 * (e - ke) / $ + "%",
                    Yt(n, b),
                    Zt(n, A)
                }
            if (P && (m || K ? (addCSSRule(me, "#" + Fe + " > .tns-item", "font-size:" + h.getComputedStyle(z[0]).fontSize + ";", getCssRulesLength(me)),
            addCSSRule(me, "#" + Fe, "font-size:0;", getCssRulesLength(me))) : I && forEach(z, function(e, t) {
                e.style.marginLeft = getSlideMarginLeft(t)
            })),
            R) {
                if (y) {
                    var i = w && M.autoHeight ? getTransitionDurationStyle(M.speed) : "";
                    addCSSRule(me, "#" + Fe + "-mw", i, getCssRulesLength(me))
                }
                i = getInnerWrapperStyles(M.edgePadding, M.gutter, M.fixedWidth, M.speed, M.autoHeight),
                addCSSRule(me, "#" + Fe + "-iw", i, getCssRulesLength(me)),
                I && (i = P && !K ? "width:" + getContainerWidth(M.fixedWidth, M.gutter, M.items) + ";" : "",
                y && (i += getTransitionDurationStyle(ie)),
                addCSSRule(me, "#" + Fe, i, getCssRulesLength(me))),
                i = P && !K ? getSlideWidthStyle(M.fixedWidth, M.gutter, M.items) : "",
                M.gutter && (i += getSlideGutterStyle(M.gutter)),
                I || (y && (i += getTransitionDurationStyle(ie)),
                S && (i += getAnimationDurationStyle(ie))),
                i && addCSSRule(me, "#" + Fe + " > .tns-item", i, getCssRulesLength(me))
            } else {
                update_carousel_transition_duration(),
                W.style.cssText = getInnerWrapperStyles(X, Y, Q, re),
                I && P && !K && (H.style.width = getContainerWidth(Q, Y, $));
                i = P && !K ? getSlideWidthStyle(Q, Y, $) : "";
                Y && (i += getSlideGutterStyle(Y)),
                i && addCSSRule(me, "#" + Fe + " > .tns-item", i, getCssRulesLength(me))
            }
            if (B && R)
                for (var o in B) {
                    ...
                    "")
                      ...
                      , l = ""
                      , u = ""
                      , d = K ? null : getOption("items", o)
                      , c = getOption("fixedWidth", o)
                      , f = getOption("speed", o)
                      , p = getOption("edgePadding", o)
                      , g = getOption("autoHeight", o)
                      , v = getOption("gutter", o);
                    y && w && getOption("autoHeight", o) && "speed"in a && (r = "#" + Fe + "-mw{" + getTransitionDurationStyle(f) + "}"),
                    ("edgePadding"in a || "gutter"in a) && (s = "#" + Fe + "-iw{" + getInnerWrapperStyles(p, v, c, f, g) + "}"),
                    I && P && !K && ("fixedWidth"in a || "items"in a || Q && "gutter"in a) && (l = "width:" + getContainerWidth(c, v, d) + ";"),
                    y && "speed"in a && (l += getTransitionDurationStyle(f)),
                    l = l && "#" + Fe + "{" + l + "}",
                    ("fixedWidth"in a || Q && "gutter"in a || !I && "items"in a) && (u += getSlideWidthStyle(c, v, d)),
                    "gutter"in a && (u += getSlideGutterStyle(v)),
                    !I && "speed"in a && (y && (u += getTransitionDurationStyle(f)),
                    S && (u += getAnimationDurationStyle(f))),
                    u = u && "#" + Fe + " > .tns-item{" + u + "}",
                    i = r + s + l + u,
                    i && me.insertRule("@media (min-width: " + o / 16 + "em) {" + i + "}", me.cssRules.length)
                }
        }
        function initTools() {
            if (updateSlideStatus(),
            L.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + getLiveRegionStr() + "</span>  of " + F + "</div>"),
            _ = L.querySelector(".tns-liveregion .current"),
            it) {
                var e = fe ? "stop" : "start";
                Pt ? setAttrs(Pt, {
                    "data-action": e
                }) : M.autoplayButtonOutput && (L.insertAdjacentHTML(getInsertPosition(M.autoplayPosition), '<button type="button" data-action="' + e + '">' + Ht[0] + e + Ht[1] + ge[0] + "</button>"),
                Pt = L.querySelector("[data-action]")),
                Pt && addEvents(Pt, {
            ...
            if (tt) {
                if (Ct)
                    ...
                    for (var t = "", n = nt ? "" : 'style="display:none"', i = 0; i < F; i++)
                        t += '<button type="button" data-nav="' + i + '" tabindex="-1" aria-controls="' + Fe + '" ' + n + ' aria-label="' + Ot + (i + 1) + '"></button>';
                    t = '<div class="tns-nav" aria-label="Carousel Pagination">' + t + "</div>",
                    L.insertAdjacentHTML(getInsertPosition(M.navPosition), t),
                    Ct = L.querySelector(".tns-nav"),
                    St = Ct.children
                }
                if (updateNavVisibility(),
                y) {
                    var o = y.substring(0, y.length - 18).toLowerCase()
                      , a = "transition: all " + ie / 1e3 + "s";
                    o && (a = "-" + o + "-" + a),
                    addCSSRule(me, "[aria-controls^=" + Fe + "-item]", a, getCssRulesLength(me))
                }
                setAttrs(St[At], {
                    "aria-label": Ot + (At + 1) + Mt
                }),
                removeAttrs(St[At], "tabindex"),
                Yt(St[At], Lt),
                addEvents(Ct, Qe)
            }
            et && (pt || vt && ht || (L.insertAdjacentHTML(getInsertPosition(M.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' + Fe + '">' + le[0] + '</button><button type="button" data-controls="next" tabindex="-1" aria-controls="' + Fe + '">' + le[1] + "</button></div>"),
            pt = L.querySelector(".tns-controls")),
            vt && ht || (vt = pt.children[0],
            ht = pt.children[1]),
            M.controlsContainer && setAttrs(pt, {
                "aria-label": "Carousel Navigation",
                tabindex: "0"
            }),
            (M.controlsContainer || M.prevButton && M.nextButton) && setAttrs([vt, ht], {
                "aria-controls": Fe,
                tabindex: "-1"
            }),
            (M.controlsContainer || M.prevButton && M.nextButton) && (setAttrs(vt, {
                "data-controls": "prev"
            }),
            setAttrs(ht, {
                "data-controls": "next"
            ...
            pt ? addEvents(pt, Ke) : (addEvents(vt, Ke),
            addEvents(ht, Ke))),
            disableUI()
        }
        function initEvents() {
            ...
            de && addEvents(H, Je, M.preventScrollOnTouch),
            ce && addEvents(H, $e),
            ne && addEvents(k, Ze),
            "inner" === D ? Ve.on("outerResized", function() {
                resizeTasks(),
                Ve.emit("innerLoaded", info())
            }) : (B || Q || K || re || !P) && addEvents(h, {
                resize: onResize
            }),
            re && ("outer" === D ? Ve.on("innerLoaded", doAutoHeight) : Ge || doAutoHeight()),
            doLazyLoad(),
            Ge ? disableSlider() : Ue && freezeSlider(),
            Ve.on("indexChanged", additionalUpdates),
            "inner" === D && Ve.emit("innerLoaded", info()),
            "function" == typeof He && He(info()),
            q = !0
        }
        function destroy() {
            if (me.disabled = !0,
            ...
            ne && removeEvents(k, Ze),
            pt && removeEvents(pt, Ke),
            Ct && removeEvents(Ct, Qe),
            removeEvents(H, Xe),
            removeEvents(H, Ye),
            Pt && removeEvents(Pt, {
                click: toggleAutoplay
            ...
            de && removeEvents(H, Je),
            ce && removeEvents(H, $e);
            var a = [V, gt, mt, yt, Et, Wt];
            for (var t in p.forEach(function(e, t) {
                var n = "container" === e ? L : M[e];
                if ("object" === _typeof(n) && n) {
                    var i = !!n.previousElementSibling && n.previousElementSibling
                      , o = n.parentNode;
                    n.outerHTML = a[t],
                    M[e] = i ? i.nextElementSibling : o.firstElementChild
                }
            }),
            p = b = T = x = A = P = L = W = H = O = V = z = F = N = G = K = Q = X = Y = Z = $ = ee = te = ne = ie = oe = ae = re = me = ye = j = Ce = Ee = be = Te = xe = Ae = we = Le = Oe = Me = ke = Re = Be = De = Ne = Pe = We = He = Ve = ze = Fe = Ge = qe = je = Ue = _e = Ke = Qe = Xe = Ye = Ze = Je = $e = et = tt = nt = it = ot = at = rt = lt = ut = U = se = le = pt = gt = vt = ht = ct = ft = ue = Ct = Et = St = bt = Tt = xt = At = wt = Lt = Ot = Mt = fe = pe = Nt = ge = ve = Pt = Wt = he = Ht = kt = Rt = Bt = Dt = It = Ft = Gt = Vt = qt = zt = jt = de = ce = null,
            this)
        ...
        function resizeTasks(e) {
            if (q) {
                "outer" === D && Ve.emit("outerResized", info(e)),
                G = getWindowWidth();
                var t, n = N, i = !1;
                B && (setBreakpointZone(),
                t = n !== N,
                t && Ve.emit("newBreakpointStart", info(e)));
                var o, a, r = $, s = Ge, l = Ue, u = ne, d = se, c = ue, f = de, p = ce, g = fe, v = ve, h = he, m = ke;
                if (t) {
                    var y = Q
                      , S = re
                      , C = le
                ...
                if (ne = getOption("arrowKeys"),
                se = getOption("controls"),
                ue = getOption("nav"),
                de = getOption("touch"),
                J = getOption("center"),
                ce = getOption("mouseDrag"),
                fe = getOption("autoplay"),
                ve = getOption("autoplayHoverPause"),
                he = getOption("autoplayResetOnVisibility"),
                t && (Ge = getOption("disable"),
                Q = getOption("fixedWidth"),
                ie = getOption("speed"),
                re = getOption("autoHeight"),
                le = getOption("controlsText"),
                ge = getOption("autoplayText"),
                pe = getOption("autoplayTimeout"),
                R || (X = getOption("edgePadding"),
                Y = getOption("gutter"))),
                resetVariblesWhenDisable(Ge),
                Z = getViewportWidth(),
                P && !K || Ge || (setSlidePositions(),
                P || (updateContentWrapperHeight(),
                i = !0)),
                (Q || K) && (xe = getRightBoundary(),
                De = Me()),
                (t || Q) && ($ = getOption("items"),
                ...
                a && (Q || K || (De = Me()),
                Ut())),
                t && Ge !== s && (Ge ? disableSlider : enableSlider)(),
                je && (t || Q || K) && (Ue = getFreeze(),
                Ue !== l && (Ue ? (doContainerTransform(getContainerTransformValue(getStartIndex(0))),
                freezeSlider()) : (unfreezeSlider(),
                i = !0))),
                resetVariblesWhenDisable(Ge || Ue),
                fe || (ve = he = !1),
                ne !== u && (ne ? addEvents : removeEvents)(k, Ze),
                se !== d && (se ? pt ? showElement(pt) : (vt && showElement(vt),
                ht && showElement(ht)) : pt ? hideElement(pt) : (vt && hideElement(vt),
                ht && hideElement(ht))),
                ue !== c && (ue ? (showElement(Ct),
                updateNavVisibility()) : hideElement(Ct)),
                de !== f && (de ? addEvents(H, Je, M.preventScrollOnTouch) : removeEvents(H, Je)),
                ce !== p && (ce ? addEvents : removeEvents)(H, $e),
                fe !== g && (fe ? (Pt && showElement(Pt),
                Rt || Dt || startAutoplay()) : (Pt && hideElement(Pt),
                Rt && stopAutoplay())),
                ve !== v && (ve ? addEvents : removeEvents)(H, Xe),
                he !== h && (he ? addEvents : removeEvents)(k, Ye),
                t) {
                    if (Q === y && J === E || (i = !0),
                    re !== S && (re || (W.style.height = "")),
                    se && le !== C && (vt.innerHTML = le[0],
                    ht.innerHTML = le[1]),
                    Pt && ge !== b) {
                        var A = fe ? 1 : 0
                          , w = Pt.innerHTML
                          , L = w.length - b[A].length;
                        w.substring(L) === b[A] && (Pt.innerHTML = w.substring(0, L) + ge[A])
                    }
                } else
                    J && (Q || K) && (i = !0);
                if ((a || Q && !K) && (bt = getPages(),
                updateNavVisibility()),
                o = ke !== m,
                o ? (Ve.emit("indexChanged", info()),
                i = !0) : a ? o || additionalUpdates() : (Q || K) && (doLazyLoad(),
                updateSlideStatus(),
                updateLiveRegion()),
                a && !I && updateGallerySlidePositions(),
                !Ge && !Ue) {
                    if (t && !R && (X === x && Y === T || (W.style.cssText = getInnerWrapperStyles(X, Y, Q, ie, re)),
                    P)) {
                        I && (H.style.width = getContainerWidth(Q, Y, $));
                        var O = getSlideWidthStyle(Q, Y, $) + getSlideGutterStyle(Y);
                        removeCSSRule(me, getCssRulesLength(me) - 1),
                        addCSSRule(me, "#" + Fe + " > .tns-item", O, getCssRulesLength(me))
                    }
                    re && doAutoHeight(),
                    i && (doContainerTransformSilent(),
                    Re = ke)
                }
                t && Ve.emit("newBreakpointEnd", info(e))
            }
        }
        function getFreeze() {
            if (!Q && !K) {
            ...
            var t = Q ? (Q + Y) * F : j[F]
              , n = X ? Z + 2 * X : Z + Y;
            return J && (n -= Q ? (Z - Q) / 2 : (Z - (j[ke + 1] - j[ke] - Y)) / 2),
            t <= n
        }
        ...
        function disableUI() {
            !fe && Pt && hideElement(Pt),
            !ue && Ct && hideElement(Ct),
            se || (pt ? hideElement(pt) : (vt && hideElement(vt),
            ht && hideElement(ht)))
        }
        function enableUI() {
            fe && Pt && showElement(Pt),
            ue && Ct && showElement(Ct),
            se && (pt ? showElement(pt) : (vt && showElement(vt),
            ht && showElement(ht)))
        }
        function freezeSlider() {
            if (!_e) {
                if (X && (W.style.margin = "0px"),
                Ee)
                    for (var e = "tns-transparent", t = Ee; t--; )
                        I && Yt(z[t], e),
                        Yt(z[be - t - 1], e);
                disableUI(),
                _e = !0
        ...
        function disableSlider() {
            if (!qe) {
                if (me.disabled = !0,
                H.className = H.className.replace(ze.substring(1), ""),
                removeAttrs(H, ["style"]),
                ae)
                    for (var e = Ee; e--; )
                        I && hideElement(z[e]),
                        hideElement(z[be - e - 1]);
                if (P && I || removeAttrs(W, ["style"]),
                !I)
                    for (var t = ke, n = ke + F; t < n; t++) {
                        var i = z[t];
                        removeAttrs(i, ["style"]),
                        Zt(i, b),
                        Zt(i, A)
        ...
        function enableSlider() {
            if (qe) {
                ...
                ae)
                    for (var e = Ee; e--; )
                        I && showElement(z[e]),
                        showElement(z[be - e - 1]);
                if (!I)
                    for (var t = ke, n = ke + F; t < n; t++) {
                        var i = z[t]
                          , o = t < ke + $ ? b : A;
                        i.style.left = 100 * (t - ke) / $ + "%",
                        Yt(i, o)
                    }
                enableUI(),
                qe = !1
        ...
        function getVisibleSlideRange(e) {
            ...
            K)
                ...
                if (Q) {
                    var t = Q + Y;
                    n = J || X ? (a = Math.floor(i / t),
                    Math.ceil(o / t - 1)) : a + Math.ceil(Z / t) - 1
                } else if (J || X) {
                    var r = $ - 1;
                    if (n = J ? (a -= r / 2,
                    ke + r / 2) : ke + r,
        ...
        function doLazyLoad() {
            if (ye && !Ge) {
                var e = getVisibleSlideRange();
                e.push(Se),
                getImageArray.apply(null, e).forEach(function(e) {
                    if (!Xt(e, lt)) {
                        var t = {};
                        t[d] = function(e) {
                            e.stopPropagation()
        ...
        function getImageArray(e, t, n) {
            var i = [];
            for (n = n || "img"; e <= t; )
                forEach(z[e].querySelectorAll(n), function(e) {
                    i.push(e)
                }),
                e++;
            return i
        ...
        function imgsLoadedCheck(n, e) {
            return U ? e() : (n.forEach(function(e, t) {
                !ye && e.complete && imgCompleted(e),
                Xt(e, lt) && n.splice(t, 1)
            }),
            n.length ? void Kt(function() {
                imgsLoadedCheck(n, e)
            }) : e())
        }
        ...
        function update_carousel_transition_duration() {
            I && re && (w.style[y] = ie / 1e3 + "s")
        }
        function getMaxSlideHeight(e, t) {
            for (var n = [], i = e, o = Math.min(e + t, be); i < o; i++)
                n.push(z[i].offsetHeight);
            return Math.max.apply(null, n)
        }
        function updateInnerWrapperHeight() {
            var e = re ? getMaxSlideHeight(ke, $) : getMaxSlideHeight(Ee, F)
              , t = w || W;
        ...
        function setSlidePositions() {
            ...
            forEach(z, function(e, t) {
                t && j.push(e.getBoundingClientRect()[n] - o),
                t === be - 1 && j.push(e.getBoundingClientRect()[i] - o)
            })
        }
        function updateSlideStatus() {
            var e = getVisibleSlideRange()
              ...
              , i = e[1];
            forEach(z, function(e, t) {
                n <= t && t <= i ? hasAttr(e, "aria-hidden") && (removeAttrs(e, ["aria-hidden", "tabindex"]),
                Yt(e, rt)) : hasAttr(e, "aria-hidden") || (setAttrs(e, {
                    "aria-hidden": "true",
                    tabindex: "-1"
                }),
                Zt(e, rt))
        ...
        function updateGallerySlidePositions() {
            for (var e = ke + Math.min(F, $), t = be; t--; ) {
                var n = z[t];
                ke <= t && t < e ? (Yt(n, "tns-moving"),
                n.style.left = 100 * (t - ke) / $ + "%",
                Yt(n, b),
                Zt(n, A)) : n.style.left && (n.style.left = "",
                Yt(n, A),
                Zt(n, b)),
                Zt(n, T)
            }
            setTimeout(function() {
                forEach(z, function(e) {
                    Zt(e, "tns-moving")
                })
            }, 300)
        }
        function updateNavStatus() {
            if (ue && (At = 0 <= xt ? xt : getCurrentNavIndex(),
            xt = -1,
            At !== wt)) {
                var e = St[wt]
                  , t = St[At];
        ...
        function updateControlsStatus() {
            if (se && !oe && !ae) {
                var e = ct ? vt.disabled : isAriaDisabled(vt)
                  , t = ft ? ht.disabled : isAriaDisabled(ht)
                  , n = ke <= Be
                  , i = !oe && De <= ke;
                n && !e && disEnableElement(ct, vt, !0),
                !n && e && disEnableElement(ct, vt, !1),
                i && !t && disEnableElement(ft, ht, !0),
                !i && t && disEnableElement(ft, ht, !1)
            }
        }
        ...
        function getSliderWidth() {
            return Q ? (Q + Y) * be : j[be]
        }
        function getCenterGap(e) {
            null == e && (e = ke);
            var t = X ? Y : 0;
            return K ? (Z - t - (j[e + 1] - j[e] - Y)) / 2 : Q ? (Z - Q) / 2 : ($ - 1) / 2
        }
        function getRightBoundary() {
            var e = X ? Y : 0
              , t = Z + e - getSliderWidth();
            return J && !ae && (t = Q ? -(Q + Y) * (be - 1) - getCenterGap() : getCenterGap(be - 1) - j[be - 1]),
            0 < t && (t = 0),
            t
        }
        function getContainerTransformValue(e) {
            ...
            P && !K)
                ...
                t = -j[e],
                J && K && (t += getCenterGap());
            return Te && (t = Math.max(t, xe)),
            t += !P || K || Q ? "px" : "%",
            t
        }
        function doContainerTransformSilent(e) {
            resetDuration(H, "0s"),
            doContainerTransform(e)
        }
        ...
        function animateSlide(e, t, n, i) {
            ...
            for (var a = e; a < o; a++) {
                var r = z[a];
                i || (r.style.left = 100 * (a - ke) / $ + "%"),
                x && s && (r.style[s] = r.style[l] = x * (a - e) / 1e3 + "s"),
                Zt(r, t),
                Yt(r, n),
                i && Ce.push(r)
            }
        ...
        function render(e, t) {
            Ae && Ut(),
            ke === Re && !t || (Ve.emit("indexChanged", info()),
            Ve.emit("transitionStart", info()),
            re && doAutoHeight(),
            Rt && e && 0 <= ["click", "keydown"].indexOf(e.type) && stopAutoplay(),
            We = !0,
            _t())
        }
        function strTrans(e) {
        ...
        function onTransitionEnd(e) {
            if (I || We) {
                if (Ve.emit("transitionEnd", info(e)),
                !I && 0 < Ce.length)
                ...
                if (!e || !I && e.target.parentNode === H || e.target === H && strTrans(e.propertyName) === strTrans(we)) {
                    if (!Ae) {
                        var i = ke;
                        Ut(),
                        ke !== i && (Ve.emit("indexChanged", info()),
                        doContainerTransformSilent())
                    }
                    "inner" === D && Ve.emit("innerLoaded", info()),
                    We = !1,
        ...
        function goTo(e, t) {
            if (!Ue)
                if ("prev" === e)
                    ...
                    var n = getAbsIndex()
                      , i = 0;
                    if ("first" === e ? i = -n : "last" === e ? i = I ? F - $ - n : F - 1 - n : ("number" != typeof e && (e = parseInt(e)),
                    isNaN(e) || (t || (e = Math.max(0, Math.min(F - 1, e))),
                    i = e - n)),
                    !I && i && Math.abs(i) < $) {
                        var o = 0 < i ? 1 : -1;
                        i += Be <= ke + i - F ? F * o : 2 * F * o * -1
                    }
                    ke += i,
                    I && ae && (ke < Be && (ke += F),
                    De < ke && (ke -= F)),
                    getAbsIndex(ke) !== getAbsIndex(Re) && render(t)
                }
        }
        function onControlsClick(e, t) {
            ...
            if (!t) {
                e = getEvent(e);
                for (var i = getTarget(e); i !== pt && [vt, ht].indexOf(i) < 0; )
                    i = i.parentNode;
                var o = [vt, ht].indexOf(i);
                0 <= o && (n = !0,
                t = 0 === o ? -1 : 1)
            }
            if (oe) {
                if (ke === Be && -1 === t)
                    return void goTo("last", e);
                if (ke === De && 1 === t)
                    return void goTo("first", e)
            }
            t && (ke += ee * t,
            K && (ke = Math.floor(ke)),
        ...
        function onNavClick(e) {
            ...
            e = getEvent(e);
            for (var t = getTarget(e); t !== Ct && !hasAttr(t, "data-nav"); )
                t = t.parentNode;
            if (hasAttr(t, "data-nav")) {
                var n = xt = Number(getAttr(t, "data-nav"))
                  , i = Q || K ? n * F / bt : n * $
                  , o = nt ? n : Math.min(Math.ceil(i), F - 1);
                goTo(o, e),
                At === n && (Rt && stopAutoplay(),
                xt = -1)
            }
        }
        function setAutoplayTimer() {
            kt = setInterval(function() {
                onControlsClick(null, Nt)
            }, pe),
            Rt = !0
        }
        ...
        function updateAutoplayButton(e, t) {
            ...
            Pt.innerHTML = Ht[0] + e + Ht[1] + t
        }
        function startAutoplay() {
            setAutoplayTimer(),
            Pt && updateAutoplayButton("stop", ge[1])
        }
        function stopAutoplay() {
            stopAutoplayTimer(),
            Pt && updateAutoplayButton("start", ge[0])
        }
        function play() {
            fe && !Rt && (startAutoplay(),
            Dt = !1)
        ...
        function onVisibilityChange() {
            k.hidden ? Rt && (stopAutoplayTimer(),
            It = !0) : It && (setAutoplayTimer(),
            It = !1)
        }
        function mouseoverPause() {
            Rt && (stopAutoplayTimer(),
            Bt = !0)
        }
        ...
        function onControlsKeydown(e) {
            e = getEvent(e);
            var t = [o.LEFT, o.RIGHT].indexOf(e.keyCode);
            0 <= t && (0 === t ? vt.disabled || onControlsClick(e, -1) : ht.disabled || onControlsClick(e, 1))
        }
        function setFocus(e) {
            e.focus()
        }
        function onNavKeydown(e) {
            e = getEvent(e);
            var t = k.activeElement;
            if (hasAttr(t, "data-nav")) {
                var n = [o.LEFT, o.RIGHT, o.ENTER, o.SPACE].indexOf(e.keyCode)
                  , i = Number(getAttr(t, "data-nav"));
                0 <= n && (0 === n ? 0 < i && setFocus(St[i - 1]) : 1 === n ? i < bt - 1 && setFocus(St[i + 1]) : (xt = i,
                goTo(i, e)))
            }
        }
        function getEvent(e) {
        ...
        function getTarget(e) {
            return e.target || h.event.srcElement
        }
        ...
        function getMoveDirectionExpected() {
            return getTouchDirection(toDegree(Gt.y - Ft.y, Gt.x - Ft.x), Ne) === M.axis
        }
        function onPanStart(e) {
            ...
            fe && Rt && stopAutoplayTimer(),
            qt = !0,
            zt && (Qt(zt),
            zt = null);
            var t = getEvent(e);
            Ve.emit(isTouchEvent(e) ? "touchStart" : "dragStart", info(e)),
            !isTouchEvent(e) && 0 <= ["img", "a"].indexOf(getLowerCaseNodeName(getTarget(e))) && preventDefaultBehavior(e),
            Gt.x = Ft.x = t.clientX,
            Gt.y = Ft.y = t.clientY,
            I && (Vt = parseFloat(H.style[we].replace(Le, "")),
            resetDuration(H, "0s"))
        }
        function onPanMove(e) {
            if (qt) {
                ...
                I ? zt = zt || Kt(function() {
                    panUpdate(e)
                }) : ("?" === Pe && (Pe = getMoveDirectionExpected()),
                Pe && (dt = !0)),
                ("boolean" != typeof e.cancelable || e.cancelable) && dt && e.preventDefault()
            }
        }
        function panUpdate(e) {
            if (Pe) {
                ...
                "?" === Pe && (Pe = getMoveDirectionExpected()),
                Pe) {
                    !dt && isTouchEvent(e) && (dt = !0);
                    try {
                        e.type && Ve.emit(isTouchEvent(e) ? "touchMove" : "dragMove", info(e))
                    } catch (e) {}
                    var t = Vt
                      , n = jt(Gt, Ft);
                    if (!P || Q || K)
                        ...
                        var i = a ? n * $ * 100 / ((Z + Y) * be) : 100 * n / (Z + Y);
                        t += i,
                        t += "%"
                    }
                    H.style[we] = Le + t + Oe
                    ...
                    I ? zt = Kt(function() {
                        if (P && !K) {
                            ...
                            if (t <= 0)
                                ...
                                for (var n = 0; n < be && t >= j[n]; )
                                    ke = n,
                                    t > j[n] && o < 0 && (ke += 1),
                                    n++
                        }
                        render(i, o),
                        Ve.emit(isTouchEvent(i) ? "touchEnd" : "dragEnd", info(i))
                    }) : Pe && onControlsClick(i, 0 < o ? -1 : 1)
                }
            }
            "auto" === M.preventScrollOnTouch && (dt = !1),
            Ne && (Pe = "?"),
            fe && !Rt && setAutoplayTimer()
        }
        function updateContentWrapperHeight() {
            var e = w || W;
            e.style.height = j[ke + $] - j[ke] + "px"
        }
        function getPages() {
            var e = Q ? (Q + Y) * F / Z : F / $;
            return Math.min(Math.ceil(e), F)
        }
...
var slider223327 = tns({
    container: '#carousel-223327',
    controlsContainer: '#carousel-controls-223327',
    autoplay: true,
    ...
    controlsText: ["<i class='carousel__controls--prev icon-circle-arrow-left'></i>", "<i class='carousel__controls--next icon-circle-arrow-right'></i>"],
    slideBy: 'page',
    loop: true,
    autoHeight: false,
    mouseDrag: true,
    lazyload: true,
    lazyloadSelector: '.loaded',
    onInit: function(e) {
        const images = e.container.querySelectorAll('img.image-embed-item');
...
function GDataBusinessStickyNav() {
    ...
    this.DOMElements = {
        ...
        stickyNavWrapper: document.querySelector(".stickynav-outer"),
        stickyNavToggle: document.querySelector(".stickynav__toggle"),
        stickyNavItemLinks: document.querySelectorAll(".stickynav__nav__list__item__link")
    },
    this.init = function() {
        l._fixTop(),
        l._toggleStickyNav(),
        l._setActiveClassToNativeLinks(),
        l._scrollToAnchorLinkOnClick(),
        l._toggleActiveClassOnScroll(),
        l._setActiveItemNameAsToggleTitle()
    }
    ,
    this._fixTop = function() {
        var c = 0;
        window.addEventListener("scroll", function() {
            var t, e, s = l.DOMElements.stickyNavWrapper, i = s.classList.contains("scroll-up-fixed"), n = s.getBoundingClientRect().top <= 0, o = window.scrollY <= l.DOMElements.siteHeader.offsetHeight;
            i ? (t = window.pageYOffset,
            e = "down",
            i = "up",
            n && (c < t && !s.classList.contains(e) ? (s.classList.remove(i),
            s.classList.add(e)) : t < c && s.classList.contains(e) && (s.classList.remove(e),
            s.classList.add(i))),
            o && (s.classList.remove(e),
            s.classList.remove(i)),
            c = t) : (n && s.classList.add("stick"),
            o && s.classList.remove("stick"))
        })
    }
    ,
    this._toggleStickyNav = function() {
        l.DOMElements.stickyNavToggle.addEventListener("click", n._toggleStickyNavBodyClass)
    }
    ,
    this._setActiveClassToNativeLinks = function() {
        n.DOMElements.stickyNavItemLinks.forEach(function(t) {
            window.location.href === t.href && t.classList.add("active")
        })
    }
    ,
    this._scrollToAnchorLinkOnClick = function() {
        n.DOMElements.stickyNavItemLinks.forEach(function(e) {
            ...
            e.addEventListener("click", function(t) {
                t.preventDefault(),
                n._toggleStickyNavBodyClass(),
                !1 === e.classList.contains("b2b-lightbox") && n._scrollTo("#" + n._getHashFromUrl(e.href))
            }))
        })
    }
    ,
    this._toggleActiveClassOnScroll = function() {
        for (var t, e = 0, s = [], i = 0; i < o.length; i++)
            s.push(n._getHashFromUrl(o[i].href));
        window.addEventListener("scroll", function() {
            t && window.cancelAnimationFrame(t),
            t = window.requestAnimationFrame(function() {
                var t = s.length - [].concat(s).reverse().findIndex(function(t) {
                    t = document.getElementById(t);
                    if (t)
                        return window.scrollY >= t.offsetTop - 200 && window.scrollY <= t.offsetTop + t.offsetHeight
                }) - 1;
                t !== e && (n._removeAllActiveClasses(),
                e = t,
                o[t] ? o[t].classList.add("active") : o[t] || n._setActiveClassToNativeLinks())
            })
        })
    }
    ,
    this._setActiveItemNameAsToggleTitle = function() {
        var t, e = "";
        n.DOMElements.stickyNavItemLinks.forEach(function(t) {
            t.classList.contains("active") && (e = t.innerText)
        }),
        e || (t = document.querySelector(".stickynav__title").innerText,
        t && (e = t)),
        l.DOMElements.stickyNavToggle.innerHTML = e + '<i class="icon-circle-arrow-down"></i>'
    }
    ,
    this._removeAllActiveClasses = function() {
        return n.DOMElements.stickyNavItemLinks.forEach(function(t) {
            return t.classList.remove("active")
        })
    }
    ,
    this._getHashFromUrl = function(t) {
        return t.substring(t.indexOf("#") + 1)
    }
    ,
    this._toggleStickyNavBodyClass = function() {
        return document.querySelector("body").classList.toggle("stickynav-active")
    }
    ,
    this._scrollTo = function(t) {
        var e;
        t && (e = "scrollBehavior"in document.documentElement.style,
        t = document.querySelector(t),
        t && (e ? n._nativeScrollTo(t) : n._fallbackScrollTo(t.offsetTop, 600)))
    }
    ,
    this._nativeScrollTo = function(t) {
        window.scroll({
            top: t.offsetTop,
            left: 0,
            behavior: "smooth"
    ...
    ,
    this._fallbackScrollTo = function(s, i) {
        var n = document.scrollingElement || document.documentElement
          , o = n.scrollTop
          , c = s - o
          , l = +new Date
          , a = function easeInOutQuad(t, e, s, i) {
            return t /= i / 2,
            t < 1 ? s / 2 * t * t + e : (t--,
            -s / 2 * (t * (t - 2) - 1) + e)
        }
          , t = function animateScroll(t) {
            var e = +new Date
              , e = e - l;
            n.scrollTop = parseInt(a(e, o, c, i)),
            e < i ? requestAnimationFrame(animateScroll) : n.scrollTop = s
        };
        t()
    }
}
var GdWebsite = GdWebsite || {};
GdWebsite.BusinessStickyNav = new GDataBusinessStickyNav,
