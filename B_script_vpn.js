...
var GdB2cHead = {
    ...
    initVideo: function initVideo() {
        var e, t = window.screen.availWidth, n = !1, o = "low";
        1024 < t && (n = !0,
        o = "high"),
        void 0 !== window.navigator.connection && (e = window.navigator.connection,
        t = ["slow-2g", "2g", "3g"],
        (-1 < t.indexOf(e.effectiveType) || !0 === e.saveData) && (n = !1)),
        document.querySelectorAll(".b2c2020header--video video, .b2c2021header--video video").forEach(function(i) {
            var e;
            !0 === n ? (e = i.querySelectorAll('[data-video-qty="' + o + '"]'),
            e.forEach(function(e) {
                var t = document.createElement("source");
                t.setAttribute("src", e.getAttribute("data-video-src")),
                t.setAttribute("type", e.getAttribute("data-video-type")),
                i.appendChild(t),
                i.style.opacity = 1
            }),
            i.play(),
            document.addEventListener("visibilitychange", function() {
                "visible" === document.visibilityState ? i.play() : i.pause()
            }, !1)) : i.parentNode.removeChild(i)
        })
    },
    initObserver: function initObserver() {
        GdWebsite.Functions.registerObserver("b2cHeadVideoStartStop", {
            rootMargin: "0px"
        }, function(e, t) {
            e.forEach(function(e) {
                e.intersectionRatio <= 0 ? e.target.paused || e.target.pause() : 0 <= e.intersectionRatio && e.target.paused && e.target.play()
            })
        }, ".b2c2020header--video video, .b2c2021header--video video", function() {})
    }
};
GdB2cHead.initDevicesStuff(),
GdB2cHead.initVideo(),
window.addEventListener("DOMContentLoaded", function() {
    GdB2cHead.initObserver()
});
...
var CountUp = function CountUp(t, e, a, n, r, i) {
    for (var o = 0, u = ["webkit", "moz", "ms", "o"], s = 0; s < u.length && !window.requestAnimationFrame; ++s)
        window.requestAnimationFrame = window[u[s] + "RequestAnimationFrame"],
    ...
    function formatNumber(t) {
        ...
        e = t.split("."),
        a = e[0],
        n = 1 < e.length ? l.options.decimal + e[1] : "",
        r = /(\d+)(\d{3})/,
        l.options.useGrouping)
            for (; r.test(a); )
                a = a.replace(r, "$1" + l.options.separator + "$2");
        return l.options.prefix + a + n + l.options.suffix
    }
    function easeOutExpo(t, e, a, n) {
    ...
    i && "object" === _typeof(i))
        for (var m in l.options)
            i.hasOwnProperty(m) && null !== i[m] && (l.options[m] = i[m]);
    "" === l.options.separator && (l.options.useGrouping = !1),
    l.initialize = function() {
        return !!l.initialized || (l.d = "string" == typeof t ? document.getElementById(t) : t,
        l.d ? (l.startVal = Number(e),
        l.endVal = Number(a),
        ensureNumber(l.startVal) && ensureNumber(l.endVal) ? (l.decimals = Math.max(0, n || 0),
        l.dec = Math.pow(10, l.decimals),
        l.duration = 1e3 * Number(r) || 2e3,
        l.countDown = l.startVal > l.endVal,
        l.frameVal = l.startVal,
        l.initialized = !0,
        !0) : (console.error("[CountUp] startVal or endVal is not a number", l.startVal, l.endVal),
        !1)) : (console.error("[CountUp] target is null or undefined", l.d),
        !1))
    }
    ,
    ...
    l.update = function(t) {
        ...
        l.startVal = l.frameVal,
        l.endVal = Number(t),
        ensureNumber(l.endVal) ? (l.countDown = l.startVal > l.endVal,
        l.rAF = requestAnimationFrame(l.count)) : console.error("[CountUp] update() - new endVal is not a number", t))
    }
    ,
    l.initialize() && l.printValue(l.startVal)
};
GdWebsite.Functions.registerObserver("countUp", {
    rootMargin: "0px",
    threshold: [0]
}, function(t, s) {
    t.forEach(function(t) {
        var e, a, n, r, i, o, u;
        0 < t.intersectionRatio && (e = String(t.target.dataset.countup),
        a = -1 !== e.indexOf(",") ? "," : ".",
        n = (e.replace(",", ".").split(".")[1] || []).length,
        r = t.target.dataset.duration ? t.target.dataset.duration : 3,
        i = t.target.dataset.suffix ? t.target.dataset.suffix : "",
        o = t.target.dataset.prefix ? t.target.dataset.prefix : "",
        u = new CountUp(t.target.id,0,parseFloat(e.replace(",", ".")),n,r,{
            useEasing: !0,
            useGrouping: !1,
            decimal: a,
            prefix: o,
