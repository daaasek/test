function GDataBusinessCardGroup() {
    var t = this
      , r = this;
    this.DOMElements = {
        cardGroup: document.querySelectorAll(".card-group"),
        cards: document.querySelectorAll(".card-group .card"),
        cardsToggle: document.querySelectorAll(".card-group [data-card-toggle]")
    },
    this.init = function() {
        t._equalizeHeightsListener(),
        t._toggleMoreItems()
    }
    ,
    this._equalizeHeightsListener = function() {
        var e;
        t._equalizeHeights(),
    ...
    ,
    this._equalizeHeights = function() {
        768 <= window.innerWidth && t.DOMElements.cardGroup.forEach(function(e) {
            t._setMinHeight(e.querySelectorAll(".card__header")),
            t._setMinHeight(e.querySelectorAll(".card__body--more")),
            t._setMinHeight(e.querySelectorAll(".card__footer--more")),
            t._setMinHeight(e.querySelectorAll(".card__more__inner--body"))
        })
    }
    ,
    this._setMinHeight = function(e) {
...
GdWebsite.BusinessCardGroup = new GDataBusinessCardGroup,
GdWebsite.BusinessCardGroup.init();
...
function GDataComparisonTable() {
    var n = this;
    this.init = function() {
        n._addOSListener(),
        n._addTableHeadScrollListener(),
        n._syncArticleConfigurators()
    }
    ,
    this._addOSListener = function() {
        window.addEventListener("load", function() {
            var t = GdPlatform.getOsFamily().toLowerCase();
            "ios" !== t || document.querySelector('tr[data-comparison-os="ios"]') || (t = "mac"),
            "mac" !== t && "android" !== t && "ios" !== t && (t = "windows"),
            document.querySelectorAll(".os--" + t).forEach(function(o) {
                o.style.display = "block"
            });
            var o = document.querySelector(".comparison__body")
              , e = document.querySelector('tr[data-comparison-os="' + t + '"]');
            o.insertBefore(e, o.firstChild),
            e.querySelector(".comparison__group").classList.add("active"),
            e.querySelector(".comparison__group__body--accordion").classList.add("active"),
            document.querySelectorAll("i[data-comparison-os]").forEach(function(o) {
                o.getAttribute("data-comparison-os") !== t && o.classList.contains("icon-security-center") && (o.classList.remove("icon-security-center"),
                o.classList.add("icon-ban-circle"))
            }),
            n._accordion()
        })
    }
    ,
    this._addTableHeadScrollListener = function() {
        window.addEventListener("scroll", function() {
            var o = document.querySelector(".comparison")
              , t = document.querySelector(".comparison__head")
              , e = document.querySelector(".comparison__foot");
            o.getBoundingClientRect().top <= 0 && (t.classList.add("stick"),
            t.style.top = 0),
            e.getBoundingClientRect().top - t.offsetHeight <= 0 && (t.style.top = e.getBoundingClientRect().top - t.offsetHeight + "px"),
            0 < o.getBoundingClientRect().top && t.classList.remove("stick")
        })
    }
    ,
    this._accordion = function() {
        document.querySelectorAll(".comparison__group").forEach(function(o) {
            var t, e = o.querySelector(".comparison__group__head");
            e && (t = o.querySelector(".comparison__group__body--accordion"),
    ...
    ,
    this._syncArticleConfigurators = function() {
        document.addEventListener("consumer-article-configurator:updated", function(t) {
            t.detail.configurator.domElements.configurator.classList.contains("configurator-comparison-table") && GdStore.ConsumerConfiguratorFrontends.forEach(function(o) {
                o.domElements.configurator.classList.contains("configurator-comparison-table") && (o.updateLicenseCount(t.detail.configurator.currentLicenseCount),
                o.updateDuration(t.detail.configurator.currentDuration))
            })
        })
    }
}
var GdWebsite = GdWebsite || {};
GdWebsite.ComparsionTable = new GDataComparisonTable,
GdWebsite.ComparsionTable.init();
...
GdStoreConsumerConfiguratorFrontend = function GdStoreConsumerConfiguratorFrontend(e) {
    var n = this
      , u = this;
    this.domElements = {
        configurator: null,
    ...
    this.currentLicenseCount = null,
    this.currentDuration = null,
    this.currentProductCode = null,
    this.currentAddons = [],
    this._initialize = function(e) {
        n.domElements.configurator = e,
        n.domElements.deviceOffer = document.querySelector('[data-confi-device-rebate="' + e.id + '"]'),
        n.currentProductCode = e.getAttribute("data-confi-product"),
        n.settings.useRealUvp = "1" === e.getAttribute("data-confi-uvp"),
        n.settings.licenseCounts = e.getAttribute("data-confi-licenses").split(","),
        n.settings.durations = e.getAttribute("data-confi-durations").split(","),
        !0 === e.hasAttribute("data-confi-addons") && (n.settings.addons = e.getAttribute("data-confi-addons").split(",")),
        n._setPreselection(),
        n.settings.licenseCounts = n.settings.licenseCounts.map(function(e) {
            return parseInt(e, 10)
        }),
        n.settings.durations = n.settings.durations.map(function(e) {
            return parseInt(e, 10)
        }),
        n._initEvents(),
        n._update(!0),
        document.dispatchEvent(new CustomEvent("consumer-article-configurator:initialized",{
            detail: {
                configurator: u
            }
        }))
    ...
    this._initEvents = function() {
        n.domElements.configurator.querySelectorAll("[data-confi-trigger], [data-confi-trigger] *").forEach(function(e) {
            var t = e.getAttribute("data-confi-trigger");
            switch (t) {
            case "changeDuration":
                e.addEventListener("change", u._setDuration);
                break;
            case "increaseDuration":
                e.addEventListener("click", u._increaseDuration);
                break;
            case "decreaseDuration":
                e.addEventListener("click", u._decreaseDuration);
                break;
            case "changeLicenseCount":
                e.addEventListener("click", u._setLicenseCount);
                break;
            case "increaseLicenseCount":
                e.addEventListener("click", u._increaseLicenseCount);
                break;
            case "decreaseLicenseCount":
                e.addEventListener("click", u._decreaseLicenseCount);
                break;
            case "buy":
                e.addEventListener("click", u._addToCart);
                break;
            case "changeAddons":
                e.addEventListener("click", u._setAddons)
            }
        }),
        window.onpageshow = function(e) {
            e.persisted && u.domElements.configurator.querySelectorAll('[data-confi-trigger="buy"], button').forEach(function(e) {
                e.disabled = !1
            })
        }
    }
    ,
    this._setPreselection = function() {
        var e, t;
        !0 === n.domElements.configurator.hasAttribute("data-confi-preselect") && (e = n.domElements.configurator.getAttribute("data-confi-preselect"),
        "" !== e && (t = e.split(";"),
        u.currentDuration = parseInt(t[0]),
        u.currentLicenseCount = parseInt(t[1]),
        "" !== t[2] && (u.currentAddons = t[2].split(","))))
    }
    ,
    this._setDuration = function(e) {
        var t = parseInt(e.target.getAttribute("value"), 10);
        -1 !== u.settings.durations.indexOf(t) && (u.currentDuration = t,
        u._update(!0))
    }
    ,
    this._setAddons = function(e) {
        var t = e.target.closest('[data-confi-trigger="changeAddons"]').getAttribute("value")
          , n = u.currentAddons.indexOf(t);
        -1 < n ? u.currentAddons.splice(n, 1) : u.currentAddons.push(t),
        u._update(!0)
    }
    ,
    this._increaseDuration = function() {
        u.currentDuration = n._getIncreasedValue(u.currentDuration, u.settings.durations),
        u._update(!0)
    }
    ,
    this._decreaseDuration = function() {
        u.currentDuration = n._getDecreasedValue(u.currentDuration, u.settings.durations),
        u._update(!0)
    }
    ,
    this.updateDuration = function(e) {
        u.currentDuration = e,
        u._update(!1)
    }
    ,
    this._setLicenseCount = function(e) {
        var t = parseInt(e.target.getAttribute("value") || e.target.parentNode.getAttribute("value"), 10);
        -1 !== u.settings.licenseCounts.indexOf(t) && (u.currentLicenseCount = t,
        u._update(!0))
    }
    ,
    this._increaseLicenseCount = function() {
        u.currentLicenseCount = n._getIncreasedValue(u.currentLicenseCount, u.settings.licenseCounts),
        u._update(!0)
    }
    ,
    this._decreaseLicenseCount = function() {
        u.currentLicenseCount = n._getDecreasedValue(u.currentLicenseCount, u.settings.licenseCounts),
        u._update(!0)
    }
    ,
    this.updateLicenseCount = function(e) {
        u.currentLicenseCount = e,
        u._update(!1)
    }
    ,
    this.updateAddons = function(e) {
        u.currentAddons = e,
        u._update(!1)
    }
    ,
    this._getIncreasedValue = function(e, t) {
        var n = t.indexOf(e);
        return -1 !== n ? t[n + 1] : e
    }
    ,
    this._getDecreasedValue = function(e, t) {
        var n = t.indexOf(e);
        return -1 !== n ? 0 === n ? t.slice(-1)[0] : t[n - 1] : e
    }
    ,
    this._addToCart = function(e) {
        -1 < GdStore.ConsumerConfigurator.getPrice(u.currentProductCode, u.currentLicenseCount, u.currentDuration, "", !1, u.currentAddons) && (n.domElements.configurator.querySelectorAll('[data-confi-trigger="buy"], button').forEach(function(e) {
            e.disabled = !0
        }),
        GdStore.ConsumerConfigurator.addToCart(u.currentProductCode, u.currentLicenseCount, u.currentDuration, "", u.currentAddons))
    }
    ,
    this._setContentForConfiguratorElement = function(e, t) {
        var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null;
        null === n && (n = u.domElements.configurator);
        var r = n.querySelector('[data-confi-elem="' + e + '"]');
        r && (r.innerHTML = t)
    }
    ,
    this._getUvp = function(e) {
        var t, n = 0;
        return !0 === u.settings.useRealUvp ? (t = GdStore.ConsumerConfigurator.getArticleVariantData(u.currentProductCode, 1, 12),
        null !== t && (n = t.uvp)) : n = GdStore.ConsumerConfigurator.getPrice(u.currentProductCode, 1, 12, "", !0),
        n = n * e * (u.currentDuration / 12),
        n
    }
    ,
    this._update = function(e) {
        var t, n;
        u.currentDuration = null !== (t = u.currentDuration) && void 0 !== t ? t : u.settings.durations[0],
        u.currentLicenseCount = null !== (n = u.currentLicenseCount) && void 0 !== n ? n : u.settings.licenseCounts[0];
        var r = u.domElements.configurator.querySelectorAll('[data-confi-trigger="changeDuration"][type="radio"]');
        r.forEach(function(e) {
            parseInt(e.value) === u.currentDuration ? (e.checked = !0,
            e.parentNode.classList.add("checked")) : (e.checked = !1,
            e.parentNode.classList.remove("checked"))
        }),
        u.settings.licenseCounts.forEach(function(e) {
            var t, n, r, o, i = u.domElements.configurator.querySelector('[data-confi-license="' + e + '"]');
            i && (t = GdStore.ConsumerConfigurator.getPrice(u.currentProductCode, e, u.currentDuration),
            n = u._getUvp(e),
            u._setContentForConfiguratorElement("price", GdStore.ConsumerConfigurator.formatPrice(t, !0), i),
            r = i.querySelector("[data-confi-rebate]"),
            t < n ? (u._setContentForConfiguratorElement("uvp", GdStore.ConsumerConfigurator.formatPrice(n, !0), i),
            o = Math.round(100 * (n - t) / n),
            r.style.display = "block",
            r.innerHTML = r.dataset.confiText.replace("--", o.toString())) : (r.style.display = "none",
            u._setContentForConfiguratorElement("uvp", "", i),
            r.innerHTML = ""),
            e === u.currentLicenseCount ? i.setAttribute("data-confi-selected", 1) : i.removeAttribute("data-confi-selected"))
        });
        var o, i = GdStore.ConsumerConfigurator.getPrice(u.currentProductCode, u.currentLicenseCount, u.currentDuration, "", !1, u.currentAddons);
        -1 < i ? (u._setContentForConfiguratorElement("finalPrice", GdStore.ConsumerConfigurator.formatPrice(i, !1)),
        u._setContentForConfiguratorElement("showDuration", u.currentDuration / 12),
        u._setContentForConfiguratorElement("showLicenseCount", u.currentLicenseCount),
        o = GdStore.ConsumerConfigurator.getPrice(u.currentProductCode, u.currentLicenseCount, u.currentDuration, "", !0, u.currentAddons),
        u.domElements.deviceOffer && (o !== i ? u.domElements.deviceOffer.classList.add("active") : u.domElements.deviceOffer.classList.remove("active")),
        u.settings.durations.forEach(function(e) {
            var t, n, r, o = u.domElements.configurator.querySelector('[data-confi-elem="rebateForDuration-' + e + '"]');
            o && (t = GdStore.ConsumerConfigurator.getPrice(u.currentProductCode, u.currentLicenseCount, u.settings.durations[0]) / u.settings.durations[0],
            n = GdStore.ConsumerConfigurator.getPrice(u.currentProductCode, u.currentLicenseCount, e) / e,
            r = 0,
            n < t && (r = Math.round(100 * (t - n) / t)),
            0 < r ? (o.innerHTML = r + " %",
            o.style.display = "block") : (o.innerHTML = "",
            o.style.display = "none"))
        })) : u._setContentForConfiguratorElement("finalPrice", "--,--"),
        0 < u.settings.addons.length && u.settings.addons.forEach(function(e) {
            var t, n, r = "priceForAddon-" + e, o = u.domElements.configurator.querySelector('[data-confi-elem="' + r + '"]');
            o && (t = GdStore.ConsumerConfigurator.getAddonPrice(e, "default", u.currentDuration),
            n = GdStore.ConsumerConfigurator.getAddonPrice(e, u.currentProductCode, u.currentDuration),
            u._setContentForConfiguratorElement(r, 0 < n ? GdStore.ConsumerConfigurator.formatPrice(n, !0) : "--,--"),
            u._setContentForConfiguratorElement("defaultPriceForAddon-" + e, 0 < t ? GdStore.ConsumerConfigurator.formatPrice(t, !0) : "--,--"));
            var i = u.domElements.configurator.querySelector('[data-confi-addon="' + e + '"]');
            i && (-1 < u.currentAddons.indexOf(e) ? i.setAttribute("data-confi-selected", 1) : i.removeAttribute("data-confi-selected"))
        }),
        e && document.dispatchEvent(new CustomEvent("consumer-article-configurator:updated",{
            detail: {
                configurator: u
            }
        }))
...
;
var GdStore = GdStore || {};
GdStore.ConsumerConfiguratorFrontends = [],
document.addEventListener("GdConsumerConfiguratorLoaded", function(e) {
    document.querySelectorAll("[data-confi-consumer]").forEach(function(e) {
        GdStore.ConsumerConfiguratorFrontends.push(new GdStoreConsumerConfiguratorFrontend(e))
    })
});
...
!function(a, c, d, tt) {
    ...
    function f(t, e, i) {
        return !!Array.isArray(t) && (g(t, i[e], i),
        !0)
    }
    function g(t, e, i) {
        if (t)
    ...
    function k(t, e) {
        return _typeof(t) == nt ? t.apply(e && e[0] || tt, e) : t
    }
    function l(t, e) {
        return t === tt ? e : t
    }
    ...
    function u(t, e) {
        for (var i, n, r = e[0].toUpperCase() + e.slice(1), s = 0; s < et.length; ) {
            if (i = et[s],
            n = i ? i + r : e,
            n in t)
                return n;
    ...
    function x(e, t) {
        ...
        this.domHandler = function(t) {
            k(e.options.enable, [e]) && i.handler(t)
        }
        ,
        this.init()
    }
    function y(t) {
        ...
        return new (e || (ft ? M : dt ? P : pt ? R : L))(t,z)
    }
    function z(t, e, i) {
    ...
    function A(t, e) {
        ...
        1 < r && !i.firstMultiple ? i.firstMultiple = D(e) : 1 === r && (i.firstMultiple = !1);
        var s = i.firstInput
          , a = i.firstMultiple
        ...
        e.scale = a ? K(a.pointers, n) : 1,
        e.rotation = a ? J(a.pointers, n) : 0,
        e.maxPointers = !i.prevInput || e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers,
        C(i, e);
        var l = t.element;
        o(e.srcEvent.target, l) && (l = e.srcEvent.target),
        e.target = l
    }
    function B(t, e) {
        var i = e.center
          ...
          , r = t.prevDelta || {}
          , s = t.prevInput || {};
        e.eventType !== Et && s.eventType !== At || (r = t.prevDelta = {
            x: s.deltaX || 0,
            y: s.deltaY || 0
        },
        n = t.offsetDelta = {
    ...
    function C(t, e) {
        var i, n, r, s, o, a, h, u = t.lastInterval || e, c = e.timeStamp - u.timeStamp;
        e.eventType != It && (Tt < c || u.velocity === tt) ? (i = e.deltaX - u.deltaX,
        n = e.deltaY - u.deltaY,
        r = F(c, i, n),
        s = r.x,
        o = r.y,
        a = st(r.x) > st(r.y) ? r.x : r.y,
        h = G(i, n),
        t.lastInterval = e) : (a = u.velocity,
        s = u.velocityX,
        o = u.velocityY,
        h = u.direction),
        e.velocity = a,
    ...
    function D(t) {
        for (var e = [], i = 0; i < t.pointers.length; )
            e[i] = {
                clientX: rt(t.pointers[i].clientX),
                clientY: rt(t.pointers[i].clientY)
            },
            i++;
        return {
            timeStamp: ot(),
    ...
    function G(t, e) {
        return t === e ? _t : st(t) >= st(e) ? t < 0 ? xt : St : e < 0 ? Pt : Ct
    }
    function H(t, e, i) {
        i = i || Yt;
        var n = e[i[0]] - t[i[0]]
    ...
    function K(t, e) {
        return H(e[0], e[1], zt) / H(t[0], t[1], zt)
    }
    function L() {
        this.evEl = Ot,
        this.evWin = Nt,
    ...
    function O(e, i) {
        var n = s(e.touches)
          , r = s(e.changedTouches);
        return i & (At | It) && (n = t(n.concat(r), "identifier", !0)),
        [n, r]
    }
    function P() {
        this.evTarget = Vt,
    ...
    function Q(e, i) {
        var n = s(e.touches)
          , r = this.targetIds;
        if (i & (Et | bt) && 1 === n.length)
            return r[n[0].identifier] = !0,
            [n, n];
        var a, h = s(e.changedTouches), u = [], c = this.target, l = n.filter(function(t) {
            return o(t.target, c)
        });
        if (i === Et)
            for (a = 0; a < l.length; )
                ...
                a++;
        for (a = 0; a < h.length; )
            r[h[a].identifier] && u.push(h[a]),
            i & (At | It) && delete r[h[a].identifier],
            a++;
        return u.length ? [t(l.concat(u), "identifier", !0), u] : void 0
    }
    function R() {
        x.apply(this, arguments);
        var t = j(this.handler, this);
        this.touch = new P(this.manager,t),
    ...
    function S(t, e) {
        ...
        T.call(this, e)) : t & (At | It) && T.call(this, e)
    }
    function T(t) {
        var i, n, r, s = t.changedPointers[0];
        s.identifier === this.primaryTouch && (i = {
            x: s.clientX,
            y: s.clientY
        },
    ...
    function W(t) {
        ...
        var e = p(t, te)
          , i = p(t, ee);
        return e && i ? Qt : e || i ? e ? te : ee : p(t, Kt) ? Kt : Jt
    }
    function X() {
        if (!Bt)
            return !1;
    ...
    function Y(t) {
        this.options = at({}, this.defaults, t || {}),
        this.id = v(),
        this.manager = null,
    ...
    function Z(t) {
        return t & he ? "cancel" : t & oe ? "end" : t & se ? "move" : t & re ? "start" : ""
    }
    function $(t) {
        return t == Ct ? "down" : t == Pt ? "up" : t == xt ? "left" : t == St ? "right" : ""
    }
    function _(t, e) {
        var i = e.manager;
        return i ? i.get(t) : t
    ...
    function ha(t, e) {
        return e = e || {},
        e.recognizers = l(e.recognizers, ha.defaults.preset),
        new ia(t,e)
    }
    function ia(t, e) {
        this.options = at({}, ha.defaults, e || {}),
    ...
    function ja(i, n) {
        var r, s = i.element;
        s.style && (g(i.options.cssProps, function(t, e) {
            r = u(s.style, e),
            n ? (i.oldCssProps[r] = s.style[r],
            s.style[r] = t) : s.style[r] = i.oldCssProps[r] || ""
        }),
        n || (i.oldCssProps = {}))
    }
    function ka(t, e) {
    ...
    var et = ["", "webkit", "Moz", "MS", "ms", "o"]
      , it = c.createElement("div")
      , nt = "function"
      , rt = Math.round
      , st = Math.abs
      , ot = Date.now
    ...
    : Object.assign
      ...
      , pt = "ontouchstart"in a
      , ft = u(a, "PointerEvent") !== tt
      , dt = pt && lt.test(navigator.userAgent)
      , vt = "touch"
      , mt = "pen"
      , gt = "mouse"
      , yt = "kinect"
    ...
    a.MSPointerEvent && !a.PointerEvent && (qt = "MSPointerDown",
    ...
    i(M, x, {
        handler: function handler(t) {
            var e = this.store
              ...
              , a = o == vt
              , h = r(e, t.pointerId, "pointerId");
            s & Et && (0 === t.button || a) ? h < 0 && (e.push(t),
            h = e.length - 1) : s & (At | It) && (i = !0),
            h < 0 || (e[h] = t,
    ...
    i(N, x, {
        handler: function handler(t) {
            var e, i = kt[t.type];
            i === Et && (this.started = !0),
            this.started && (e = O.call(this, t, i),
            i & (At | It) && e[0].length - e[1].length == 0 && (this.started = !1),
    ...
    V.prototype = {
        set: function set(t) {
            t == $t && (t = this.compute()),
            Bt && this.manager.element.style && ie[t] && (this.manager.element.style[Zt] = t),
        ...
        preventDefaults: function preventDefaults(t) {
            ...
            if (!this.manager.session.prevented) {
                ...
                return (!o || !s) && (r || s && i & Dt || o && i & Rt) ? this.preventSrc(e) : void 0
            }
            e.preventDefault()
        },
    ...
    Y.prototype = {
        ...
        dropRecognizeWith: function dropRecognizeWith(t) {
            return f(t, "dropRecognizeWith", this) || (t = _(t, this),
        ...
        emit: function emit(e) {
            ...
            var i = this
              , t = this.state;
            t < oe && b(i.options.event + Z(t)),
            b(i.options.event),
            e.additionalEvent && b(e.additionalEvent),
            oe <= t && b(i.options.event + Z(t))
        },
        ...
        canEmit: function canEmit() {
            for (var t = 0; t < this.requireFail.length; ) {
                if (!(this.requireFail[t].state & (ue | ne)))
                    return !1;
                t++
            }
            return !0
        ...
        recognize: function recognize(t) {
            var e = at({}, t);
            return k(this.options.enable, [this, e]) ? (this.state & (ae | he | ue) && (this.state = ne),
            this.state = this.process(e),
            void (this.state & (re | se | oe | he) && this.tryEmit(e))) : (this.reset(),
            void (this.state = ue))
        },
    ...
    i(aa, Y, {
        ...
        process: function process(t) {
            var e = this.state
              ...
              , n = e & (re | se)
              , r = this.attrTest(t);
            return n && (i & It || !r) ? e | he : n || r ? i & At ? e | oe : e & re ? e | se : re : ue
        }
    }),
    i(ba, aa, {
        defaults: {
        ...
        directionTest: function directionTest(t) {
            var e = this.options
              ...
              , s = t.deltaX
              , o = t.deltaY;
            return r & e.direction || (n = e.direction & Dt ? (r = 0 === s ? _t : s < 0 ? xt : St,
            i = s != this.pX,
            Math.abs(t.deltaX)) : (r = 0 === o ? _t : o < 0 ? Pt : Ct,
            i = o != this.pY,
            Math.abs(t.deltaY))),
            t.direction = r,
        ...
        attrTest: function attrTest(t) {
            return aa.prototype.attrTest.call(this, t) && (this.state & re || !(this.state & re) && this.directionTest(t))
        },
    ...
    i(da, Y, {
        ...
        emit: function emit(t) {
            this.state === ae && (t && t.eventType & At ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = ot(),
    ...
    i(fa, aa, {
        ...
        attrTest: function attrTest(t) {
            ...
            return i & (Dt | Rt) ? e = t.overallVelocity : i & Dt ? e = t.overallVelocityX : i & Rt && (e = t.overallVelocityY),
            this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && st(e) > this.options.velocity && t.eventType & At
        },
        emit: function emit(t) {
    ...
    i(ga, Y, {
        ...
        process: function process(t) {
            ...
            if (r && s && n) {
                ...
                var o = !this.pTime || t.timeStamp - this.pTime < i.interval
                  , a = !this.pCenter || H(this.pCenter, t.center) < i.posThreshold;
                this.pTime = t.timeStamp,
                this.pCenter = t.center,
                a && o ? this.count += 1 : this.count = 1,
                this._input = t;
                var h = this.count % i.taps;
                if (0 === h)
        ...
        emit: function emit() {
            this.state == ae && (this._input.tapCount = this.count,
            this.manager.emit(this.options.event, this._input))
        }
    }),
    ha.VERSION = "2.0.8",
    ...
    ia.prototype = {
        ...
        recognize: function recognize(t) {
            ...
            if (!e.stopped) {
                ...
                for (var s = 0; s < n.length; )
                    i = n[s],
                    e.stopped === le || r && i != r && !i.canRecognizeWith(r) ? i.reset() : i.recognize(t),
                    !r && i.state & (re | se | oe) && (r = e.curRecognizer = i),
                    s++
            }
        },
        get: function get(t) {
        ...
        remove: function remove(t) {
            return f(t, "remove", this) || (t = this.get(t)) && (e = this.recognizers,
            i = r(e, t),
            -1 !== i && (e.splice(i, 1),
            this.touchAction.update())),
            this;
    ...
    var pe = void 0 !== a ? a : "undefined" != typeof self ? self : {};
    pe.Hammer = ha,
    "function" == typeof define && define.amd ? define(function() {
        return ha
    }) : "undefined" != typeof module && module.exports ? module.exports = ha : a[d] = ha
}(window, document, "Hammer");

function GDataComparisonBoxes() {
    var l = this;
    this.breakpoint = 1024,
    this.DOMElements = {
        comparisonBoxes: document.querySelector(".comparison-boxes"),
        comparisonControlItems: document.querySelectorAll(".comparison-boxes__controls__item")
    },
    this.init = function() {
        l._addOSListener(),
        l._initMobileSlider(),
        window.addEventListener("resize", function() {
            return l._initMobileSlider()
        })
    }
    ,
    this._addOSListener = function() {
        window.addEventListener("load", function() {
            var e = GdPlatform.getOsFamily().toLowerCase();
            "mac" !== e && "android" !== e && "ios" !== e && (e = "windows"),
            document.querySelectorAll(".comparison-boxes__item__os--" + e).forEach(function(e) {
                e.parentNode.removeChild(e)
            }),
            document.querySelectorAll(".comparison-boxes__controls__item__os--" + e).forEach(function(e) {
                e.parentNode.removeChild(e)
            }),
            l.DOMElements.comparisonBoxes.classList.add("loaded"),
            l._setDataAttributes()
        })
    }
    ,
    this._setDataAttributes = function() {
        for (var e = document.querySelectorAll(".comparison-boxes__controls__item"), t = document.querySelectorAll(".comparison-boxes__item"), i = 0; i < t.length; i++) {
            var o = parseInt(i) + 1;
            e[i].setAttribute("data-control-item", o),
            t[i].setAttribute("data-box-item", o)
        }
    }
    ,
    this._initMobileSlider = function() {
        document.documentElement.clientWidth < l.breakpoint ? function() {
            l._mobileSliderSetContainerHeight(),
            l._initMobileSwipeGestures();
            for (var n = l.DOMElements.comparisonControlItems, e = function _loop(r) {
                n[r].addEventListener("click", function() {
                    var e = l._mobileSliderGetActiveId()
                      , t = l._mobileSliderGetActiveItem()
                      , i = n[r].getAttribute("data-control-item")
                      , o = document.querySelector('[data-box-item="' + i + '"]');
                    e < i ? l._mobileSliderShowNext(t, o) : i < e && l._mobileSliderShowPrevious(t, o)
                })
            }, t = 0; t < n.length; t++)
                e(t)
        }() : l._resetMobileSlider()
    }
    ,
    this._mobileSliderSetContainerHeight = function() {
        var e = l.DOMElements.comparisonBoxes;
        e.style.height = e.querySelector(".comparison-boxes__item.active").offsetHeight + "px"
    }
    ,
    this._resetMobileSlider = function() {
        var e = l.DOMElements.comparisonBoxes;
        e.removeAttribute("style");
        for (var t = 0; t < e.children.length; t++)
            e.children[t].removeAttribute("style")
    }
    ,
    this._mobileSliderShowNext = function(e, t) {
        t.style.transform = "translateX(100%)",
        t.style.opacity = 0,
        setTimeout(function() {
            e.style.transform = "translateX(-100%)",
            l._mobileSliderChangeActiveState(e, t)
        }, 200)
    }
    ,
    this._mobileSliderShowPrevious = function(e, t) {
        t.style.transform = "translateX(-100%)",
        t.style.opacity = 0,
        setTimeout(function() {
            e.style.transform = "translateX(100%)",
    ...
    ,
    this._mobileSliderChangeActiveState = function(e, t) {
        t.style.opacity = 1,
        t.style.transform = "translateX(0)",
        e.classList.remove("active"),
        t.classList.add("active"),
        l._mobileSliderSetContainerHeight(),
        l._mobileSliderChangeControlActiveState(e, t)
    }
    ,
    this._mobileSliderChangeControlActiveState = function(e, t) {
        e = e.getAttribute("data-box-item"),
        t = t.getAttribute("data-box-item");
        document.querySelector('[data-control-item="' + e + '"]').classList.remove("active"),
        document.querySelector('[data-control-item="' + t + '"]').classList.add("active")
    }
    ,
    this._mobileSliderGetActiveId = function() {
        var e = document.querySelector(".comparison-boxes__item.active").getAttribute("data-box-item");
        return parseInt(e)
    }
    ,
    this._mobileSliderGetActiveItem = function() {
        return document.querySelector('[data-box-item="' + l._mobileSliderGetActiveId() + '"]')
    }
    ,
    this._initMobileSwipeGestures = function() {
        var e = new Hammer(l.DOMElements.comparisonBoxes);
        e.get("swipe").set({
            direction: Hammer.DIRECTION_HORIZONTAL
        }),
        e.on("swipeleft", function() {
            return l._mobileSliderTouchSwipeLeft()
        }),
        e.on("swiperight", function() {
            return l._mobileSliderTouchSwipeRight()
        })
    }
    ,
    this._mobileSliderTouchSwipeLeft = function() {
        var e = l.DOMElements.comparisonBoxes.querySelectorAll(".comparison-boxes__item").length
          , t = l._mobileSliderGetActiveId();
        t < e && l._mobileSliderTouchSwipe("left", t + 1)
    }
    ,
    this._mobileSliderTouchSwipeRight = function() {
        var e = l._mobileSliderGetActiveId();
        1 < e && l._mobileSliderTouchSwipe("right", e - 1)
    }
    ,
    this._mobileSliderTouchSwipe = function(e, t) {
        var i = l._mobileSliderGetActiveItem()
          , t = document.querySelector('[data-box-item="' + t + '"]');
        "right" === e && l._mobileSliderShowPrevious(i, t),
        "left" === e && l._mobileSliderShowNext(i, t)
    }
}
var GdWebsite = GdWebsite || {};
GdWebsite.ComparsionBoxes = new GDataComparisonBoxes,
GdWebsite.ComparsionBoxes.init();

function GDataBusinessTabs() {
    var n = this
      , o = this;
    this.breakpoint = 1024,
    this.DOMElements = {
        TabListItems: document.querySelectorAll(".tabs__list__item"),
        TabContentItems: document.querySelectorAll(".tabs__content__item")
    },
    this.Classes = {
        titleActive: "tabs__list__item--active",
        contentActive: "tabs__content__item--active"
    },
    this.init = function() {
        n._showActiveHashTab(),
        window.onpopstate = function(t) {
            o._showActiveHashTab()
        }
        ,
        n._switchActiveTabOnClick()
    }
    ,
    this._showActiveHashTab = function() {
        var t, e, s = window.location.hash, i = document.getElementById(s.substr(1));
        null !== i && i.classList.contains("tabs__content__item") && (t = i.parentNode.parentNode,
        t.querySelector("." + o.Classes.titleActive).classList.remove(o.Classes.titleActive),
        t.querySelector("." + o.Classes.contentActive).classList.remove(o.Classes.contentActive),
        e = document.querySelector(".tabs__list__item--link[href='".concat(s, "']")).parentNode,
        e.classList.add(o.Classes.titleActive),
        i.classList.add(o.Classes.contentActive),
        setTimeout(function() {
            e.scrollIntoView(!0)
        }, 50))
    }
    ,
    this._switchActiveTabOnClick = function() {
        for (var i = n.DOMElements.TabListItems, t = function _loop(s) {
            i[s].addEventListener("click", function(t) {
                t.preventDefault();
                var e = (t.target.matches("a") ? t.target : t.target.parentNode).getAttribute("href")
                  , t = document.getElementById(e.substr(1));
                history.pushState({}, e.substr(1), e),
                n._animateTab(i[s], t),
                o._removeActiveClass(o.DOMElements.TabListItems, o.Classes.titleActive),
                o._removeActiveClass(o.DOMElements.TabContentItems, o.Classes.contentActive),
                i[s].classList.add(o.Classes.titleActive),
                t.classList.add(o.Classes.contentActive),
                document.documentElement.clientWidth < o.breakpoint ? i[s].parentNode.classList.toggle("tabs__list--open") : i[s].parentNode.classList.remove("tabs__list--open")
            })
        }, e = 0; e < i.length; e++)
            t(e)
    }
    ,
    this._removeActiveClass = function(t, e) {
        for (var s = 0; s < t.length; s++)
            t[s].classList.contains(e) && t[s].classList.remove(e)
    }
    ,
    this._animateTab = function(t, e) {
        var s = document.querySelector(".tabs__list__item--active").getAttribute("data-tab-id")
          , i = t.getAttribute("data-tab-id")
          , n = "animation--slide--in--left"
          , a = "animation--slide--in--right";
        function addAnimationAtDesktopView() {
            document.documentElement.clientWidth >= o.breakpoint && (s < i ? e.classList.add(a) : e.classList.add(n))
        }
        o._removeActiveClass(o.DOMElements.TabContentItems, a),
        o._removeActiveClass(o.DOMElements.TabContentItems, n),
        window.addEventListener("resize", addAnimationAtDesktopView),
        addAnimationAtDesktopView()
    }
}
var GdWebsite = GdWebsite || {};
GdWebsite.BusinessTabs = new GDataBusinessTabs,
GdWebsite.BusinessTabs.init();
...
GdStoreConsumerConfigurator = function() {
    var e = this
      , t = this;
    this.settings = {
        min: 0,
    ...
    this.debugMode = !1,
    this.log = function(e) {
        !0 === t.debugMode && console.log("%cGD STORE B2C CONFI: " + e, "color: #000000; background-color:lightblue;")
    }
    ,
    this.initialize = function() {
        if (t.log("INITIALIZE"),
        "string" == typeof GdStore.ConsumerPriceData && "" !== GdStore.ConsumerPriceData) {
            var r = JSON.parse(window.atob(GdStore.ConsumerPriceData));
            if ("object" === _typeof(r) && null !== r) {
                e._setUserDevice(),
                e.priceData = r.p,
                e.addonData = r.a,
                e.settings = r.settings,
                t.log("DISPATCH EVENT GdConsumerConfiguratorLoaded");
                var n = document.createEvent("CustomEvent");
                return n.initEvent("GdConsumerConfiguratorLoaded", !0, !0),
                document.dispatchEvent(n),
                void e._registerGlobalEvents()
            }
        }
        t.log("ERROR: NO PRICE DATA")
    }
    ,
    ...
    ,
    this.getPriceForArticleNumber = function(t, r) {
        var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
        return e.getPrice(t, 0, 0, r, n)
    }
    ,
    this.getPrice = function(r, n) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 12
          , o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : ""
          , a = arguments.length > 4 && void 0 !== arguments[4] && arguments[4]
          , c = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : [];
        if (n < e.settings.min || n > e.settings.max)
            return -1;
        var u = e._getArticleVariant(r, n, i, o);
        if (null !== u) {
            "" === e.userDevice && e._setUserDevice();
            var d = u.prices.default[0];
            return !1 === a && "" !== e.userDevice && void 0 !== u.prices[e.userDevice] && (d = u.prices[e.userDevice][0]),
            c.length > 0 && c.forEach((function(e) {
                var n = t.getAddonPrice(e, r, i);
                -1 !== n ? d += n : d = -1
            }
            )),
            d
    ...
    ,
    this.getFormattedPriceForArticleNumber = function(t, r) {
        var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2]
          , i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : [];
        return e.getPriceFormatted(t, 0, 0, n, r, i)
    }
    ,
    this.getPriceFormatted = function(t, r) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 12
          , i = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3]
          , o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : ""
          , a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : []
          , c = e.getPrice(t, r, n, o, !1, a);
        return -1 !== c ? e.formatPrice(c, i) : ""
    }
    ,
    this.getArticleVariantData = function(t, r, n) {
        return e._getArticleVariant(t, r, n)
    }
    ,
    this._setUserDevice = function() {
        "undefined" != typeof GdPlatform && (e.userDevice = GdPlatform.getOsFamily(),
        t.log("SET USER DEVICE TO " + e.userDevice))
    }
    ,
    this._mapProductCode = function(e) {
        return "TS" === e ? "TP" : e
    }
    ,
    this._getArticleVariant = function(r, n, i, o) {
        if (r = e._mapProductCode(r),
        "object" !== _typeof(t.priceData[r]) || null === t.priceData[r])
            return t.log("NO ARTICLE SET FOR " + r),
            null;
        var a = null;
        return t.priceData[r].prices.forEach((function(e) {
            "" !== o && o === e.no && (a = e),
            i === e.duration && n === e.licenses && (a = e)
        }
        )),
        null === a ? t.log("NO ARTICLEVARIANT SET FOR " + r + " / " + n + " / " + i + " / " + o) : a.baseNo = t.priceData[r].no,
        a
    }
    ,
    this._getAddonVariant = function(r, n, i) {
        var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1;
        if (r = e._mapProductCode(r),
        "object" !== _typeof(t.addonData[r]) || null === t.addonData[r])
            return null;
        var a = t.addonData[r].prices
          , c = null;
        return a.forEach((function(e) {
            i === e.duration && o === e.licenses && (c = e)
        }
        )),
        null === c || "object" !== _typeof(c.prices[n]) || null === c.prices[n] ? null : c
    }
    ,
    this.getAddonPrice = function(r, n, i) {
        var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1;
        n = t._mapProductCode(n);
        var a = e._getAddonVariant(r, n, i, o);
        return null !== a ? a.prices[n][0] : -1
    }
    ,
    this._getCouponFromArticleVariant = function(t) {
        return "" !== e.userDevice && void 0 !== t.prices[e.userDevice] ? t.prices[e.userDevice][1] : t.prices.default[1]
    }
    ,
    this.formatPrice = function(t, r) {
        return (t / 100).toFixed(2).replace(".", e.settings.decimalPoint).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + e.settings.thousandsPoint) + " " + (!0 === r ? e.settings.currencySymbol : e.settings.currencyCode)
    }
    ,
    this.addToCart = function(r, n) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 12
          , o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : ""
          , a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : []
          , c = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0;
        r = e._mapProductCode(r);
        var u = e._getArticleVariant(r, n, i, o);
        if (null === u)
            return !1;
        var d = document.getElementById("b2c-store-configurator");
        d.querySelector('[name="tx_gdstore_basket[article]"]').value = t.priceData[r].id,
        d.querySelector('[name="tx_gdstore_basket[articleVariant]"]').value = u.id,
        d.querySelector('[name="tx_gdstore_basket[quantity]"]').value = 1,
        d.querySelector('[name="tx_gdstore_basket[coupon]"]').value = e._getCouponFromArticleVariant(u);
        var s = []
          , l = []
          , g = [];
        if (a.length > 0 && (a.forEach((function(e) {
            var n = t._getAddonVariant(e, r, i);
            null !== n && (g.push(n.id),
            l.push(t.addonData[e].id),
            s.push(n.prices[r][1]))
        }
        )),
        l.length !== a.length))
            return !1;
        d.querySelector('[name="tx_gdstore_basket[addonArticles]"]').value = l.join(","),
        d.querySelector('[name="tx_gdstore_basket[addonArticleVariants]"]').value = g.join(","),
        d.querySelector('[name="tx_gdstore_basket[addonCoupons]"]').value = s.join(","),
        d.querySelector('[name="tx_gdstore_basket[basketItemToReplace]"]').value = c || "",
        d.submit()
    }
    ,
    this._registerGlobalEvents = function() {
        document.querySelectorAll("[data-b2c-cart-product][data-b2c-cart-licenses]").forEach((function(e) {
            e.addEventListener("click", (function(r) {
                var n;
                r.preventDefault();
                var i = e.getAttribute("data-b2c-cart-product")
                  , o = parseInt(e.getAttribute("data-b2c-cart-licenses"))
                  , a = e.getAttribute("data-b2c-cart-duration");
                a = null !== a ? parseInt(a, 10) : 12;
                var c = e.getAttribute("data-b2c-cart-addons");
                c = null !== c ? c.split(",") : [];
                var u = null !== (n = e.getAttribute("data-b2c-cart-replace")) && void 0 !== n ? n : "";
                t.addToCart(i, o, a, "", c, u)
            }
            ))
        }
        ))
...
;
var GdStore = GdStore || {};
GdStore.ConsumerConfigurator = new GdStoreConsumerConfigurator,
GdStore.ConsumerConfigurator.initialize();
    ...
    this.CookieConsent = {
        ...
        initEvents: function initEvents() {
            c.CookieConsent.domElement.addEventListener("click", function(e) {
                ...
                o = "none" === e.target.getAttribute("data-cookie-save"),
                n = !o && (t || c.CookieConsent.domElement.querySelector('[data-cookie="statistics"]').checked),
                i = !o && (t || c.CookieConsent.domElement.querySelector('[data-cookie="advert"]').checked),
                a = !o && (t || c.CookieConsent.domElement.querySelector('[data-cookie="matomo"]').checked),
                !0 === c.MatomoTagManager.isInitialized && c.MatomoTagManager.submitConsentSettings("saveCookieSettings", a, n, i),
                c.CookieConsent.setCookie(n, i, a),
