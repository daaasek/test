...
!function(x, b, T) {
        ...
        for (l in w)
            if (w.hasOwnProperty(l)) {
                ...
                i = 0; i < e.length; i++)
                    a = e[i],
                    s = a.split("."),
                    1 === s.length ? _[s[0]] = o : (!_[s[0]] || _[s[0]]instanceof Boolean || (_[s[0]] = new Boolean(_[s[0]])),
                    _[s[0]][s[1]] = o),
                    C.push((o ? "" : "no-") + s.join("-"))
            }
    }
    function i(e) {
        var t, n = S.className, r = _._config.classPrefix || "";
        E && (n = n.baseVal),
        _._config.enableJSClass && (t = new RegExp("(^|\\s)" + r + "no-js(\\s|$)"),
        n = n.replace(t, "$1" + r + "js$2")),
        _._config.enableClasses && (n += " " + r + e.join(" " + r),
        E ? S.className.baseVal = n : S.className = n)
    }
    function a(e) {
    ...
    function s() {
        return "function" != typeof b.createElement ? b.createElement(arguments[0]) : E ? b.createElementNS.call(b, "http://www.w3.org/2000/svg", arguments[0]) : b.createElement.apply(b, arguments)
    }
    function c(e, t) {
        return !!~("" + e).indexOf(t)
    }
    function l(e, t) {
        if ("object" == _typeof(e))
            ...
            1 == r.length ? _[r[0]] = t : (!_[r[0]] || _[r[0]]instanceof Boolean || (_[r[0]] = new Boolean(_[r[0]])),
            _[r[0]][r[1]] = t),
            i([(t && 0 != t ? "" : "no-") + r.join("-")]),
            _._trigger(e, t)
        }
    ...
    function m(e, t, n, r) {
        var o, i, a, l, c = "modernizr", u = s("div"), d = p();
        if (parseInt(n, 10))
            for (; n--; )
                a = s("div"),
                a.id = r ? r[n] : c + (n + 1),
        ...
        d.appendChild(u),
        o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(b.createTextNode(e)),
        u.id = c,
        ...
        S.style.overflow = l,
        S.offsetHeight) : u.parentNode.removeChild(u),
        !!i
    }
    function h(e, t) {
        var n = e.length;
        ...
        if ("CSSSupportsRule"in x) {
            for (var r = []; n--; )
                r.push("(" + f(e[n]) + ":" + t + ")");
            return r = r.join(" or "),
            m("@supports (" + r + ") { #modernizr { position: absolute; } }", function(e) {
    ...
    function g(e, t, n, o) {
        ...
        for (var u, d, f, p, m, y = ["modernizr", "tspan"]; !q.style; )
            u = !0,
            q.modElem = s(y.shift()),
    ...
    E || function(e, u) {
        ...
        function a(e, t, n) {
            return t = t || u,
            f ? t.createElement(e) : (n = n || i(t),
            r = n.cache[e] ? n.cache[e].cloneNode() : h.test(e) ? (n.cache[e] = n.createElem(e)).cloneNode() : n.createElem(e),
            !r.canHaveChildren || m.test(e) || r.tagUrn ? r : n.frag.appendChild(r));
            var r
        }
        function s(e, t) {
            if (e = e || u,
            ...
            t = t || i(e);
            for (var n = t.frag.cloneNode(), o = 0, a = r(), s = a.length; o < s; o++)
                n.createElement(a[o]);
            return n
        }
        function c(t, n) {
            ...
            t.createElement = function(e) {
                return x.shivMethods ? a(e, t, n) : n.createElem(e)
            }
            ,
        ...
        var d, f, t = "3.7.3", p = e.html5 || {}, m = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, h = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, y = "_html5shiv", v = 0, g = {};
        !function() {
            try {
        ...
        e.html5 = x,
        l(u),
        "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports && (module.exports = x)
    }(void 0 !== x ? x : this, b);
    var n = "Moz O ms Webkit"
      , P = t._config.usePrefixes ? n.toLowerCase().split(" ") : [];
    t._domPrefixes = P,
    ...
    _.addTest("regions", function() {
        if (E)
            return !1;
        var e = _.prefixed("flowFrom")
          , t = _.prefixed("flowInto")
          , n = !1;
        if (!e || !t)
            return n;
        var r = s("iframe")
        ...
        o.appendChild(a),
        S.appendChild(o);
        var c, u, d = i.getBoundingClientRect();
        return i.style[t] = l,
        c = i.getBoundingClientRect(),
        u = parseInt(c.left - d.left, 10),
        S.removeChild(o),
        42 == u ? n = !0 : (S.appendChild(r),
        d = r.getBoundingClientRect(),
        r.style[t] = l,
        c = r.getBoundingClientRect(),
        0 < d.height && d.height !== c.height && 0 === c.height && (n = !0)),
        i = a = o = r = T,
        n
    });
    var z, j = (z = !("onblur"in b.documentElement),
    e);
    function e(e, t) {
        var n;
    ...
    _.addTest("hashchange", function() {
        return !1 !== j("hashchange", x) && (b.documentMode === T || 7 < b.documentMode)
    });
    ...
    _.addTest("csscalc", function() {
        var e = "width:"
          , t = "calc(10px);"
          , n = s("a");
        return n.style.cssText = e + M.join(t + e),
        !!n.style.length
    }),
    _.addTest("webaudio", function() {
        var e = "webkitAudioContext"in x
          , t = "AudioContext"in x;
        return _._config.usePrefixes && e || t
    });
    var N = "CSS"in x && "supports"in x.CSS
      , $ = "supportsCSS"in x;
    _.addTest("supports", N || $);
    var A = t._config.usePrefixes ? n.split(" ") : [];
    t._cssomPrefixes = A;
    var B, F, L = function k(e) {
        var t, n = M.length, r = x.CSSRule;
        if (void 0 === r)
            return T;
        if (!e)
            return !1;
    ...
    t.atRule = L,
    F = {}.hasOwnProperty,
    B = r(F, "undefined") || r(F.call, "undefined") ? function(e, t) {
    ...
    _.addTest("svgasimg", b.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"));
    var R = {
        elem: s("modernizr")
    };
    _._q.push(function() {
    ...
    var D = t.testStyles = m;
    _.addTest("touchevents", function() {
        var t, e;
        return "ontouchstart"in x || x.DocumentTouch && b instanceof DocumentTouch ? t = !0 : (e = ["@media (", M.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join(""),
        D(e, function(e) {
            t = 9 === e.offsetTop
        })),
        t
    ...
    D('#modernizr{font:0/0 a}#modernizr:after{content:":)";visibility:hidden;font:7px/1 a}', function(e) {
        _.addTest("generatedcontent", 7 <= e.offsetHeight)
    });
    var O, U = (O = x.matchMedia || x.msMatchMedia,
    O ? function(e) {
        var t = O(e);
    ...
    : function(e) {
        ...
        return m("@media " + e + " { #modernizr { position: absolute; } }", function(e) {
            t = "absolute" == (x.getComputedStyle ? x.getComputedStyle(e, null) : e.currentStyle).position
        }),
        t
    }
    );
    t.mq = U,
    _.addTest("mediaqueries", U("only all")),
    t.testProp = function(e, t, n) {
        return g([e], T, t, n)
    }
    ,
    t.testAllProps = v,
    t.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? L(e) : (-1 != e.indexOf("-") && (e = a(e)),
        t ? v(e, t, n) : v(e, "pfx"))
    }
    ,
    t.testAllProps = y,
    _.addTest("cssanimations", y("animationName", "a", !0)),
    _.addTest("cssfilters", function() {
        if (_.supports)
            return y("filter", "blur(2px)");
        var e = s("a");
        return e.style.cssText = M.join("filter:blur(2px); "),
        !!e.style.length && (b.documentMode === T || 9 < b.documentMode)
    }),
    ...
    _.addTest("csstransforms3d", function() {
        var e, t, n = !!y("perspective", "1px", !0), r = _._config.usePrefixes;
        return n && (!r || "webkitPerspective"in S.style) && (t = "#modernizr{width:0;height:0}",
        _.supports ? e = "@supports (perspective: 1px)" : (e = "@media (transform-3d)",
        r && (e += ",(-webkit-transform-3d)")),
        e += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}",
        D(t + e, function(e) {
            n = 7 === e.offsetWidth && 18 === e.offsetHeight
        })),
        n
    }),
    _.addTest("preserve3d", y("transformStyle", "preserve-3d")),
    _.addTest("csstransitions", y("transition", "all", !0)),
    o(),
    i(C),
    delete t.addTest,
    delete t.addAsyncTest;
    for (var H = 0; H < _._q.length; H++)
        _._q[H]();
    x.Modernizr = _
}(window, document);
